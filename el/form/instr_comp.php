        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Η Μουκάντιμα σημαίνει κυριολεκτικά ‘‘εισαγωγή”. Αυτή η φόρμα έγινε δημοφιλής προς τα μέσα του 20ού αιώνα καθώς οι συνθέτες πρόσθεταν μεγάλες εισαγωγές στις νέα δημοφιλή φόρμα <a href="../form/vocal_comp.php#ughniya">Ουγνία</a> (φόρμα μεγάλου σε διάρκεια τραγουδιού). Ανεπτυγμένες <a href="../form/instr_comp.php#muqaddima">Μουκάντιμα</a> μερικές φορές διαρκούσαν π’ανω από 5 λεπτά και συμπεριλάμβαναν πολλαπλά μέρη όπως μέρη σόλων και μετατροπίες Μακάμ.
                    </p>
                    ...
                    <p>
                        Η φόρμα Ντάριτζ (επίσημα λέγεται <em>Σαμάι Ντάριτζ</em>) είναι μία απλή οργανική σύνθεση ονομαζόμενη <a href="../iqaa/samai_darij.php">Ικάα Σαμάι Ντάριτζ</a> (3/4). Όπως στις <a href="ottoman.php">Φόρμες Οθωμανικής Ορχηστρικής μουσικής</a>, η σύνθεση Ντάριτζ στηρίζεται σε ένα κύριο Μακάμ από το οποίο παίρνει το όνομά του, ακολουθούμενο από το όνομα του συνθέτη.
                    </p>
                    <p>
