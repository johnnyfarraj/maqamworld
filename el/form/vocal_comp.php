        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>
                                        Ηχογράφηση του <strong>Μουάσαχ Μάλα αλ-Κασάτ</strong> από τον Μοχάμαντ Χαΐρι σε μακάμ Ραστ (σε μουσική Μοχάμαντ Ουθμάν).
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>
                                        Ηχογράφηση Μουασαχάτ Ουάσλα σε Μακάμ Ναχαουάντ από τον Χάσαν αλ-Χαφφάρ σε μουσική Όμαρ αλ-Μπατς.
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>H Σουάντ Μοχάμαντ (Λίβανος) ερμηνεύει το <strong>Ντάουρ Έντα Φάχεμ</strong> σε Μακάμ Χουζάμ σε μουσική Ζακαρία Άχμαντ.
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Ντάουρ <strong>Αχέμπ Ασούφακ Κούλι Ιόμ</strong> (1931) σε Μακάμ Ναχαουάντ από τον Μοχάμαντ Αμπντέλ Ουαχάμπ.
                                </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>
                                        Ηχογράφηση του Ντάουρ <strong>Νταϊάτι Μουστάκμπαλ Χαϊάτι</strong> σε Μακάμ Μπαϊάτι Σούρι σε ερμηνεία Σαμπά Φακρί (1914, μουσική Σαΐντ Νταρουίς).
                                    </span>
                                </div>
                            </label>
                        </div>
                    ...
                    <p> 
                        Η Τακτούκα (πλ. Τακατίκ) είναι το μέσο 3-4 λεπτών Αραβικό τραγούδι με πολλαπλές στροφές και ένα επαναλαμβανόμενο χοριακό (ρεφραίν). Τα Τακατίκ συνήθως χρησιμοποιούν απλούς <a href="../iqaa.php">ρυθμούς</a> όπως Ικά Μακσούμ και έχουν προσβάσιμους στίχους και μελωδία που είναι απλή προς μνημόνευση και για να τραγουδιστεί.
                    </p>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=uO8eElxaaUY">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Χαϊράνα Λε (1930)</b>
                                    <span>Ερμηνεία: Λέιλα Μουράντ σε μακάμ Ραστ (Μουσική Νταούντ Χόσνι).
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Ερμηνεία: Σαμπάχ σε μακάμ Ραστ (Μουσική Φαρίντ αλ-Άτρας).
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Τραγούδι του Μοχάμαντ Αμπντέλ Ουαχάμπ σε μακάμ Ραστ (c.1930s).</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Ερμηνεία: Φεϊρούζ (Μουσική Φιλίμων Ουάχμπι σε μακάμ Ραστ).</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Η Ουάσλα του Αμπντέλ Χάι σε μακάμ Ραστ, συμπεριλαμβάνοντας ένα Τακασίμ στο ούτι, μέρος από Σαμάι Ραστ του Τατιός Εφέντι, ένα τακασίμ στο βιολί, Λαϊάλι συνοδευόμενο από το κανονάκι, και τέλος την Τακτούκα <strong>Λε Για Μπανάσφεγκ</strong> (1961), σε σύνθεση Ριάντ Σουνμπάτι.
                                </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Μία Ουάσλα σε μακάμ Ραστ από τον Αιγύπτιο τραγουδιστή Αμπάς αλ-Μπλέιντι περιλαμβάνοντας έαν τακασίμ στο ούτι από τον Τζορτζ Μισέλ, μέρος του Σαμάι Ραστ του Τατιός Εφέντι, ένα τακασίμ στο βιολί από τον Μοχάμαντ αλ-Άκαντ, τη Μουάσαχ Ατάνι Ζαμάνι, ένα τακασίμ στο κανονάκι από τον Φίχμι Άουαντ, έπειτα Λαϊάλι, και τέλος το <strong>Ντάουρ Ίσνα ου Σούφνα</strong> (σύνθεση Μοχάμαντ Οθμάν).
                                </span>
                                </div>
                            </label>
                        </div>
