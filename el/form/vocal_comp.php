                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=asf278QZx4E">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Χάσαν αλ-Χαφάρ Ουάσλα</b>
                                    <span>
                                        Ηχογράφηση Μουασαχάτ Ουάσλα σε <a href="../maqam/nahawand.php">Μακάμ Ναχαουάντ</a> από τον Χάσαν αλ-Χαφάρ σε μουσική Όμαρ αλ-Μπατς.
                                    </span>
                                </div>
                            </label>
                        </div>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=5z8LvG5tfOE">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>αλ-Ατλάλ (1966)</b>
                                    <span>Η Κασίντα <strong>αλ-Ατλάλ</strong> (1966), σύνθεση του Ριάντ αλ-Σουνμπάτι σε ερμηνεία Ουμ Κουλθούμ.</span>
                                </div>
                            </label>
                        </div>
                    </div>
