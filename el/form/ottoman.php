                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Σαμάι σε μακάμ Χιτζάζ Κάρ Κορύντ από τον Ρόχι αλ-Χαμμάς (Παλαιστίνη-Ιράκ), περιλαμβάνοντας <a href="../iqaa/jurjina.php">Ικά Τζουρτζίνα</a> στον 4ο Χάνα.
                                </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Σαμάι σε <a href="../maqam/kurd.php">Μακάμ Κουρντ</a> από τον Αμπντού Ντάγερ (Αίγυπτος), το οποίο περιλαμβάνει μία μακριά <a href="../form/instr_comp.php#muqaddima">Μουκάντιμα</a> (σύνθεση εισαγωγής).
                                </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Λόνγκα σε <a href="../maqam/nahawand.php">Μακάμ Φαραχφάζα</a> από τον Ριάντ αλ-Σουνμπάτι (Αίγυπτος), ηχογραφημένο από την ορχήστρα του Σιμόν Σαχίν.</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=aZY8TuOB68w">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Μπάσραφ Κάρα Μπάτακ Σίκα (1929)</b>
                                    <span>Μπάσραφ Καρά Μπάτακ σε <a href="../maqam/sikah.php">Μακάμ Σίκα</a>, ηχογραφημένοτο 1929 από τον Σάμι αλ-Σάουα (Συρία) στο <a href="../instr/violin.php">βιολί</a> και Μοχάμαντ αλ-Κασάμπζι (Αίγυπτος) στο <a href="../instr/oud.php">Ούτι</a>.</span>
                                </div>
                            </label>
                        </div>
                    </div>
