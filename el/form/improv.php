        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Οι φόρμες του αυτοσχεδιασμού είναι το πιο άμεσο όχημα για να έναν mutrib, μούτριμπ (τραγουδιστή) ή έναν οργανοπαίχτη με σκοπό να συνδεθεί με το κοινό του καθώς αναπτύσσουν και δουλεύουν πάνω σε sayr ενός <a href="../maqam.php">μακάμ</a>.
                    </p>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=D0DQxDwgDw8">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Τακτούκα Λε Για Μπανάφσεγκ</b>
                                    <span>
                                        Η ηχογράφηση του κομματιού φόρμας <a href="vocal_comp.php#taqtuqa">Τακτούκα</a> Λε Για Μπανάφσεγκ (σε μουσική Ριάντ αλ-Σουνμπάτι) σε ερμηνεία Σάλεχ Αμπντέλ είναι μία μακριά <a href="../form/vocal_comp.php#wasla">Ουάσλα</a> που αρχίζει με ένα τακσίμ <a href="../instr/oud.php">Ούτι</a>, μετέπειτα <a href="../form/ottoman.php#samai">Σαμάι</a>, στη συνέχεια τακσίμ <a href="../instr/qanun.php">Κανονάκι</a>, επανεμφάνιση του <em>Τεσλίμ</em> από το <a href="../form/ottoman.php#samai">Σαμάι</a>, ύστερα ένα Λαγιάλι, κι όλα αυτά σε <a href="../maqam/rast.php">Μακάμ Ραστ</a>.
                                </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>
                                        Ο τραγουδιστής από το Χαλέπι Μοχάμαντ Χαΐρι αρχίζει την <a href="../form/vocal_comp.php#wasla">Ουάσλα</a> του σε <a href="../maqam/bayati.php">Μακάμ Μπαγιάτι</a> με ένα <a href="../form/ottoman.php#samai">Σαμάι</a> ακολουθούμενο από Μαουάλ <strong>Σαντούκ Άννι ελ-Αΐντα</strong>.
                                </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>
                                        Η Κασίντα του Μοχάμαντ Χαΐρι <strong>Για Μαν Γιάρα Άντμουαι</strong> σε <a href="../maqam/rast.php">Μακάμ Ραστ</a>.
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>
                                        Τακσίμ στο <a href="../instr/violin.php">βιολί</a> σε <a href="../maqam/bayati.php">Μακάμ Μπαγιάτι</a> από τον Αμπούντ Άμπντελ Αλ, ακολουθούμενο από <a href="../form/ottoman.php#samai">Σαμάι</a> Μπαγιάτι “Ιμπραχίμ αλ-Αριάν”.
                                    </span>
                                </div>
                            </label>
                        </div>
