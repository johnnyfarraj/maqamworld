  ...
  <body class="iqaas-page">
    ...
    <div class="page">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <a href="#" class="show-side-menu d-none d-md-block btn btn-primary above-list"><i class="fa fa-fw fa-bars"></i> Ευρετήριο Ρυθμών</a>
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Ευρετήριο Ρυθμών</a>
                    ...
                    <p>
                        Μπορείτε να αρχίσετε την εξερεύνηση των Αραβικών ρυθμών χρησιμοποιώντας το <strong>Ευρετήριο Ρυθμών</strong> (στοιχειοθετημένοι αλφαβητικά) ή χρησιμοποιώντας τον πίνακα παρακάτω (στοιχειοθετημένοι βάσι αριθμού παλμών σε κάθε μέτρο):
                    </p>
