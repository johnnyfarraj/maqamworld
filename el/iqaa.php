        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Μπορείτε να αρχίσετε την εξερεύνηση των Αραβικών ρυθμών χρησιμοποιώντας το <strong>Ευρετήριο Ρυθμών</strong> (στοιχειοθετημένοι αλφαβητικά) ή χρησιμοποιώντας τον πίνακα παρακάτω (στοιχειοθετημένοι βάσει αριθμού παλμών σε κάθε μέτρο):
                    </p>
