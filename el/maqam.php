      ...
      <div class="row">
        ...
        <div class="col-md-9 col-sm-9">
          ...
          <div class="heading text-center jins">
            ...
            <h3>Ένα σύστημα κλιμάκων, συνήθεις μελωδικές φράσεις,</h3> 
            <h3>μετατροπιακές πιθανότητες, πρώτυπα διανθισμάτων,</h3> 
            <h3>και αισθητικές συμβάσεις</h3>
          </div>
          ...
          <p>
           ...
           Το πρώτο Τζινς ξεκινάει το μακάμ με την τονική στην πρώτη στην 1η βαθμίδα, και το δεύτερο Τζινς ξεκινάει 
           στο <em>γάμμαζ</em> (σημείο που επίκειται μετατροπία) το οποίο συνήθως βρίσκεται στην τελευταία νότα του πρώτου Τζινς. 
           Εάν ένα τρίτο Τζινς χρησιμοποιείται, τότε η τονική του συμπίπτει με την βαθμίδα <em>γάμμαζ</em> του δεύτερου Τζινς, 
