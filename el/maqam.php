      ...
      <div class="row">
        ...
        <div class="col-md-9 col-sm-9">
          ...
          <div class="heading text-center jins">
            ...
            <h3>μετατροπιακών πιθανοτήτων, πρώτυπων διανθισμάτων,</h3> 
          ...
          <div class="text-center mt-2 mb-3">
            <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/maqam.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Μακάμ/Μακαμάτ</a>
          </div>

          <p>
           Το Αραβικό Μακάμ (πλ. Μακαμάτ) είναι ένα σύστημα κλιμάκων, συνήθων μελωδικών φράσεων, μετατροπιακών πιθανοτήτων, τεχνικών διανθισμάτων και κανόνων αισθητικής όπου μαζί διαμορφώνουν ένα πλούσιο μελωδικό πλαίσιο δράσης και παράδοση στην καλλιτεχνία. Η μελωδική ανάπτυξη/πορεία των μακάμ (τόσο στην σύνθεση όσο και στον αυτοσχεδιασμό) μέσα σε αυτό το πλαίσιο λέγεται <em>Σάιερ</em>. 
         </p>

          <p>
           Κάθε Μακάμ μπορεί να χτιστεί συνδυάζοντας δύο (ή σε μερικές περιπτώσεις) μέρη κλιμάκων ή χτίζοντας υπομονάδες (τετράχορδα) οι οποίες λέγονται <a href="jins.php">Τζινς</a> (πλ. <em>Αζνάς</em>). Το Μακάμ λαμβάνει τα διαστήματά του, μελωδική συμπεριφορά και γενική διάθεση από αυτά τα συστατικά Αζνάς. Το πρώτο Τζινς ξεκινάει το μακάμ με την τονική στην πρώτη στην 1η βαθμίδα, και το δεύτερο Τζινς ξεκινάει στο <em>γαμάζ</em> (σημείο που επίκειται μετατροπία) το οποίο συνήθως βρίσκεται στην τελευταία νότα του πρώτου Τζινς. Εάν ένα τρίτο Τζινς χρησιμοποιείται, τότε η τονική του συμπίπτει με την βαθμίδα <em>γαμάζ</em> του δεύτερου Τζινς, και πάει λέγοντας. Η νότα αμέσως κάτω της τονικής λέγεται νότα οδηγός.
         </p>
          ...
          <p>
           Σύμφωνα με την παράδοση, τα μακαμάτ κατηγοριοποιούνται σε οικογένειες βάσει κοινού πρώτου (θεμέλιου) Τζινς. Το θεμέλιο Τζινς παίζει τον μεγαλύτερο ρόλο στον προσδιορισμό του μακάμ. Το πιο κοινό μακάμ σε κάθε παρακλάδι συνήθως μοιράζεται το ονομά του με αυτό του θεμέλιου Τζινς. Τα υπόλοιπα μακαμάτ στην ίδια οικογένεια λέγονται παρακλάδια μακαμάτ, και στηρίζονται στην χρήση διαφορετικού δεύτερου (άνω) Τζινς.
         </p>
