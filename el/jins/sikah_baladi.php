        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>To Τζινς Σίκα Μπάλαντι Μπάλαντι δεν έχει νότες <em>γάμμαζ</em>, και ως εκ τούτου έχει ακαθόριστο μέγεθος. Η μελωδία του είναι επικεντρωμένη στην τονική του, καταγεγραμένη εδώ στον φθόγγο Σολ. To Ziνς Σίκα Μπάλαντι είναι πολύ δύσκολο να αποτυπωθεί με ακρίβεια στο χαρτί, αντιθέτως είναι καλύτερα τα διαστήματά του και επιτόνισή του ν μαθαίνονται με το αυτί. To Ziνς Σίκα Μπάλαντι προκύπτει στην οκτάβα του <a href="../maqam/sikah_baladi.php">Μακάμ Σίκα Μπάλαντι</a>.
                    </p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span><img src="/img/cd.png"> Χάσαν αλ-Χαφφάρ</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span><img src="/img/cd.png"> Κάμαρ 14</span>
                                </div>
                            </label>
                        </div>
                    </div>
