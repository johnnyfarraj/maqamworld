            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/saba_zamzam.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Σάμπα Ζάμζαμ</a>
                    </div>
                    ...
                    <p>To Τζινς Σάμπα Ζάμζαμ (όπως και το <a href="saba.php">Τζινς Σάμπα</a>) έχει ακαθόριστο μέγεθος. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Ρε και δύο πιθανές νότες <em>γαμάζ</em>: η 3η βαθμίδα (Φα) ή η 6η βαθμίδα (Σι&#x266d;). To Τζινς Σάμπα Ζάμζαμ είναι το πρώτο Τζινς στο <a href="../maqam/saba_zamzam.php">Μακάμ Σάμπα Ζάμζαμ</a>.
                    </p>
