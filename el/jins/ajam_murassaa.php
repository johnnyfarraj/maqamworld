        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        To Τζινς Άτζαμ Μουράσα είναι ένα 5χορδο. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Φα και την νότα <em>γαμμάζ</em> στον φθόγγο Σολ. To Τζινς Άτζαμ Μουράσα δεν είναι μέρος κανενός μακάμ και συνήθως συμβαίνει ως μετατροπία από <a href="ajam.php">Τζινς Άτζαμ</a>.</p>
