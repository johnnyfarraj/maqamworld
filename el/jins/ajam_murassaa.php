            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/ajam_murassaa.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Άτζαμ Μουράσα</a>
                    </div>
                    ...
                    <p>
                        To Τζινς Άτζαμ Μουράσα είναι ένα 5χορδο. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Φα και την νότα <em>γαμάζ</em> στον φθόγγο Σολ. To Τζινς Άτζαμ Μουράσα δεν είναι μέρος κανενός μακάμ και συνήθως συμβαίνει ως μετατροπία από <a href="ajam.php">Τζινς Άτζαμ</a>.</p>
                    ...
                    <div class="track " data-song="/audio/jins/ajam_murassaa/3ala_shatt_bahr_el_hawa.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1" >
                                <div class="info">
                                    <b>Άλα Σάττι Μπάχρ ελ-Χάουα</b>
                                    <span>Κάρεμ Μαχμούντ</span>
                                    <span>Μουσική Μαχμούντ αλ-Σαρίφ</span>
                                </div>
                            </label>
                        </div>
                    </div>
