        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        To Τζινς Άτζαμ είναι ένα 5χορδο. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Ντο και την νότα <em>γαμμάζ</em> στον φθόγγο Σολ. To Τζινς Άτζαμ είναι το πρώτο Τζινς στα <a href="../maqam/ajam.php">Μακάμ Άτζαμ</a> και <a href="../maqam/shawq_afza.php">Μακάμ Σάουκ Άφζα</a>.
                    </p>
