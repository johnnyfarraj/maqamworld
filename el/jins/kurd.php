            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/kurd.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Κουρντ</a>
                    </div>
                    ...
                    <p>
                        To Τζινς Κουρντ είναι ένα 4χορδο. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Ρε και την νότα <em>γαμάζ</em> στο Σολ. To Τζινς Κουρντ είναι το πρώτο Τζινς στo <a href="../maqam/kurd.php">Μακάμ Κουρντ</a>.
                    </p>
