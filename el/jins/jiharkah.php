            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/jiharkah.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Τζιχάρκα</a>
                    </div>
                    ...
                    <p>
                        To Τζινς Τζιχάρκα είναι ένα 5χορδο. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Φα και την νότα <em>γαμάζ</em> στον φθόγγο Ντο. Η 3η και 4η βαθμίδα συνήθως παίζονται ελαφρά χαμηλότερα από όπως σημειώνεται. To Τζινς Τζιχάρκα είναι το πρώτο τζινς στο <a href="../maqam/jiharkah.php">Μακάμ Τζιχάρκα</a>.
                    </p>
