        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        To Τζινς Ναχαουάντ είναι ένα 5χορδο. Στην παρούσα καταγραφή του έχει την τονική στον φθόγγο Ντο και την νότα γαμμάζ στον φθόγγο Σολ. To τζινς Ναχαουάντ είναι το πρώτο τζινς στο <a href="../maqam/nahawand.php">Μακάμ Ναχαουάντ</a>.
                    </p>
