...
$page_keywords = "Μακάμ, Τζινς, Ρυθμοί, Φόρμες, Mουσικά Όργανα, Δημοσιεύσεις, Οικογένεια Μακάμ Άτζαμ, Μακάμ Άτζαμ Ουσαϊράν, Μακάμ Σάουκ Άφζα";
$page_language = "el";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/ajam.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Άτζαμ</a>
                    </div>

                    <p>
                        Η οικογένεια των μακάμ Άτζαμ αποτελείται από μακαμάτ που αρχίζουν με <a href="../jins/ajam.php">Τζινς Άτζαμ</a>.
                    </p>

                    
                    <ul>
                        <li><a href="ajam.php">Μακάμ Άτζαμ</a></li>
                        <li><a href="ajam_ushayran.php">Μακάμ Άτζαμ Ουσαϊράν</a></li>
