            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/rast.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ραστ</a>
                    </div>
                    ...
                    <p>
                        Το Μακάμ Ραστ είναι το κύριο <em>μακάμ</em> στην <a href="f_rast.php">Οικογένεια Μακάμ Ραστ</a>, και είναι μακράν ένα από τα πιο δημοφιλή και κοινά μακαμάτ στο Αραβικό ρεπερτόριο. Η κλίμακά του αρχίζει με την βάση <a href="../jins/rast.php">Τζινς Ραστ</a>, ακολουθούμενη στην 5η βαθμίδα είτε από <a href="../jins/upper_rast.php">Τζινς Άνω Ραστ</a> (με την τονική στην 8η βαθμίδα) ή <a href="../jins/nahawand.php">Τζινς Ναχαουάντ</a>.
                    </p>
