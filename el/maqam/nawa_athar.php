...
$page_title = "Μακάμ Νάουα Άθαρ";
$page_description = "Μακάμ Νάουα Άθαρ";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/nawa_athar.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Νάουα Άθαρ</a>
                    </div>
                    ...
                    <p>
                        Το Μακάμ Νάουα Άθαρ είναι άλλο ένα δημοφιλές μακάμ στην <a href="f_nikriz.php">Οικογένεια Μακάμ Νικρίζ</a>. Η κλίμακά του αρχίζει με την βάση <a href="../jins/nikriz.php">Τζινς Νικρίζ</a> στην τονική, ακολουθούμενη είτε από <a href="../jins/hijazkar.php">Τζινς Χιτζασκάρ</a> στην 5η βαθμίδα.
                    </p>
                    <p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Το Συριακό Μουσικό Σύνολο της Χομς</span>
