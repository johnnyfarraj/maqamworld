            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/athar_kurd.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Άθαρ Κουρντ</a>
                    </div>
                    ...
                    <p>
                        Το Μακάμ Άθαρ Κουρντ είναι ένα σπάνιο μακάμ το οποίο φαίνεται να είναι μια εξέλιξη του 20ου αιώνα. Η κλίμακά του αρχίζει με την βάση <a href="../jins/athar_kurd.php">Τζινς Άθαρ Κουρντ</a> στην τονική, ακολουθούμενη είτε από <a href="../jins/hijazkar.php">Τζινς Χιτζασκάρ</a> επικεντρωμένο στην 5η βαθμίδα.
		            </p>
                    <p>
