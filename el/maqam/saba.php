            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/saba.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Σάμπα</a>
                    </div>
                    ...
                    <p>
                        Το μακάμ Σάμπα είναι ένα πολύ δημοφιλές και κοινό μακάμ στο Αραβικό ρεπερτόριο. Η κλίμακά του αρχίζει με <a href="../jins/saba.php">Τζινς Σάμπα</a> στην τονική, αλληλεπικαλυπτόμενο από <a href="../jins/hijaz.php">Τζινς Χιτζάζ</a> στην 3η βαθμίδα, ακολουθούμενο είτε από <a href="../jins/ajam.php">Τζινς Άτζαμ</a> ή <a href="../jins/nikriz.php">Τζινς Νικρίζ</a> στην 6η βαθμίδα.
                    </p>
