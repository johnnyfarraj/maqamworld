            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/bayati_shuri.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Μπαϊάτι Σούρι</a>
                    </div>
                    ...
                    <p>
                       Το Μακάμ Μπαϊάτι Σούρι είναι μία παραλλαγή του <a href="bayati.php">Μακάμ Μπαϊάτι</a> με χαμηλωμένη την 5η βαθμίδα. Αρχίζει με την βάση <a href="../jins/bayati.php">Τζινς Μπαϊάτι</a> στην τονική, ακολουθούμενη από <a href="../jins/hijaz.php">Τζινς Χιτζάζ</a> στην 4η βαθμίδα.
                    </p>   
                    <p>
