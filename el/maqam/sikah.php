        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Το Μακάμ Σίκα είναι το κύριο μακάμ στην <a href="f_sikah.php">οικογένεια Σίκα</a>. Η κλίμακά του αρχίζει με την βάση <a href="../jins/sikah.php">Τζινς Σίκα</a> στην τονική, ακολουθούμενη από <a href="../jins/upper_rast.php">Τζινς Άνω Ραστ</a> στην 3η βαθμίδα (με την τονική της στην 6η βαθμίδα) και έπειτα <a href="../jins/rast.php">Τζινς Ραστ</a> στην 6η βαθμίδα (η οποία είναι δευτερεύουσα νότα <em>γαμμάζ</em>).
                    </p>
