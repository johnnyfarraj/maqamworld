            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/huzam.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Χουζάμ</a>
                    </div>
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/rahat_al_arwah`.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ράχατ αλ-Αρουάχ</a>
                    </div>
                    ...
                    <p>
                        Το Μακάμ Χουζάμ είναι μακράν το πιο κοινό μακάμ στην <a href="f_sikah.php">Οικογένεια Μακάμ Σίκα</a>, και αρχίζει στον φθόγγο Μι<i class="icon-halfflat"></i> (μίση ύφεση). Η κλίμακά του αρχίζει με την βάση <a href="../jins/sikah.php">Τζινς Σίκα</a> στην τονική, ακολουθούμενη από <a href="../jins/hijaz.php">Τζινς Χιτζάζ</a> στην 3η βαθμίδα, έπειτα <a href="../jins/rast.php">Τζινς Ραστ</a> στην 6η βαθμίδα.
                    </p>

                    <p>
                        Η μεταφορά του Μακάμ Χουζάμ στον φθόγγο Σι<i class="icon-halfflat"></i> (μίση ύφεση) έχει την δική του ονομασία: <strong>Μακάμ Ράχατ αλ-Αρουάχ</strong>. Και τα δύο μακαμάτ έχουν ακριβώς την ίδια πορεία/ανάπτυξη.
                    </p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span><img src="/img/cd.png"> Νάγαμ αλ-Αμς Vol. 13 (Χουζάμ)</span>
                                </div>
                            </label>
                        </div>
                    </div>
