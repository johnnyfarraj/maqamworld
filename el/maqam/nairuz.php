            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/nairuz.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ναϊρούζ</a>
                    </div>
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/yakah.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Γιάκα</a>
                    </div>
                    ...
                    <p>
                        Το <strong>Μακάμ Ναϊρούζ</strong> αρχίζει με την ρίζα <a href="../jins/rast.php">Τζινς Ραστ</a> στην τονική, ακολουθούμενη από <a href="../jins/bayati.php">Τζινς Μπαϊάτι</a> στην 5η βαθμίδα.
                    </p>
                    <p>
