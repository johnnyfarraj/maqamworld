        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Το Αιγυπτιακό Μάζχαρ είναι ένα πολύ βαρύ τύμπανο με μεγάλα κύμβαλα. Είναι σχεδιασμένο για βαρύ χτύπημα σε δυνατά και πολυποίκικιλα ρυθμικά σύνολα, όπως αυτά της γαμήλιας συνοδείας (Ζάφφα), όπου ο ρυθμός είναι <a href = "../iqaa/zaffa.php">Ικά Ζάφφα</a>.
                    </p>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Αιγυπτιακός γάμος (Ζάφφα) με ένα μεγάλο συγκρότημα κρουστών χρησιμοποιώντας ένα συνδυασμό από Αιγυπτιακά Μάζχαρ, <a href="katim.php">Κάτεμ</a> και <a href="tabla.php">Τάμπλα</a>, ολα με συνθετικά δέρματα.
                                    </span>
                                </div>
                            </label>
                        </div>
