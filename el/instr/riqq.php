            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3 mobile-left">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/riqq.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ρεκ</a>
                    </div>
                    ...
                    <p>
                        Το ρεκ είναι συνήθως το μόνο κρουστό όργανο σε ένα σύνολο <em>Ταχτ</em> (Παραδοσιακή Αραβική ορχήστρα) και ο μουσικός που το παίζει λέγεται <strong>Ντάμπετ αλ-Ικά</strong> που σημαίνει <em>χειριστής του ρυθμού</em>.
                    </p>
