            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3 mobile-left">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/katim.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Κάτεμ</a>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Αιγυπτιακός γάμος (Ζάφφα) με ένα μεγάλο συγκρότημα κρουστών χρησιμοποιώντας ένα συνδυασμό από <a href="mazhar.php">Αιγυπτιακά Μάζχαρ</a>, Κάτεμ και <a href="tabla.php">Τάμπλα</a>, όλα με συνθετικά δέρματα.
                                </span>
                                </div>
                            </label>
                        </div>
