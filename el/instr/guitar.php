        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Η ηλεκτρική κιθάρα πρωτοχρησιμοποιήθηκε στην Αραβική μουσική στα τέλη της δεκαετίας του ’60 στην Αίγυπτο, από τον Ομάρ Χόρσιντ. Σε μερικές ηλεκτρικές κιθάρες εφαρμόστηκαν έξτρα τάστα (όπως το <a href="buzuq.php">μπούζουκ</a>) ώστε να παίζονται κάποια από τα Αραβικά <a href="../maqam.php">μακάμια</a> με μόρια του τόνου. Κυρίως όμως η ηλεκτρική κιθάρα χρησιμοποιήθηκε χωρίς καμία τεχνική επέμβαση ή ηχητικές παραμορφώσεις, την Αραβικότητα της στην μελωδική διάνθηση. Η χρήση  της ηλεκτρικής κιθάρας ήταν συνδυαστικά μελωδίες και απλές συγχορδίες (π.χ. ματζόρε, μινόρε).
                    </p>
