            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        ...
                        <h3>TODO Plays melody and simple chords</h3>
                    </div>
                    ...
                    <p>
                        Η ηλεκτρική κιθάρα πρωτοχρησιμοποιήθηκε στην Αραβική μουσική στα τέλη της δεκαετίας του ’60 στην Αίγυπτο, από τον Ομάρ Χόρσιντ. Σε μερικές ηλεκτρικές κιθάρες εφαρμόστηκαν έξτρα τάστα (όπως το <a href="buzuq.php">μπουζούκ</a>) ώστε να παίζονται κάποια από τα Αραβικά <a href="../maqam.php">μακάμια</a> με μόρια του τόνου. Κυρίως όμως η ηλεκτρική κιθάρα χρησιμοποιήθηκε χωρίς καμία τεχνική επέμβαση, βασιζόμενη για την Αραβικότητα της στην μελωδική διάνθηση. Η χρήση  της ηλεκτρικής κιθάρας ήταν συνδυαστικά μελωδίες και απλές συγχορδίες (π.χ. ματζόρε, μινόρε).
                    </p>
