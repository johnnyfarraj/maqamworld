                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=b9s1GvFSa68">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Ομάρ Χόρσιντ</b>
                                    <span>Ο πρωτοπόρος της ηλεκτρικής κιθάρας Ομάρ Χόρσιντ παίζει το τραγούδι της Ουμ Κουλθούμ <strong>Άγαντaν Αλκάκα</strong> (1971, σε μουσική Μοχάμαντ Αμπντέλ Ουαχάμπ).
                                    </span>
                                </div>
                            </label>
                        </div>
