            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3 mobile-left">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/oud.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Oud</a>
                    </div>

                    <p>
                    Το Ούτι (aussi orthographié ‘Ud) est un des instruments les plus populaires de la musique arabe.
                    ...
                    <p>Το Ούτι a en général cinq paires de cordes accordées à l'unisson plus une corde plus basse que les autres et non doublée.
                    ...
                    <p>
                    Το Ούτι a un timbre chaud ainsi qu'un large ambitus (à peu près trois octaves).
                    ...
                    <p>Το Ούτι est plus ou moins le même instrument que celui que l'on peut trouver dans plusieurs autres pays de la région
