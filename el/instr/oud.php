            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="image-with-caption">
                        ...
                        <span>Συριακό ούτι, κατασκεύη των αδερφών Ναχάτ (δεξιά) και Ιρακινό ούτι, κατασκευή του Μοχάμμαντ Φαντίλ (αριστερά). &copy; 2018 MaqamWorld</span>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>Ο Αιγύπτιος βιρτουόζος ουτίστας και συνθέτης Μοχάμμαντ Αλ Κασάμπζι παίζει <a href="../form/improv.php#taqsim">τακασίμ</a> στο <a href="../maqam/rast.php">μακάμ Ραστ</a> (ηχογραφηση στο Αραβικό Μουσικό Ωδείο, Κάιρο, 1955).
                                    </span>
                                </div>
                            </label>
                        </div>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=zGoY5QYLnYs&t=0s">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Φαρίντ αλ-Άτρας</b>
                                    <span>Ο Σύριος βιρτουόζος ουτίστας Φαρίντ αλ-Άτρας (επίσης γνωστός και ως “Βασιλιάς του Ουτιού”) παίζει <a href="../form/improv.php#taqsim">τακασίμ</a> στο ούτι σε <a href="../maqam/bayati.php">μακάμ Μπαϊάτι</a> ακολουθούμενο απο την συνθεσή του “<strong>Αλ Ραμπί</strong>” (1949).
                                    </span>
                                </div>
                            </label>
                        </div>
			         ...
			         <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=OCmheJ929fo&t=0s">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Σιμόν Σαχίν</b>
                                    <span>Ο Παλαιστίνιος ουτίστας Σιμόν Σαχίν παίζει σε <a href="../maqam/hijaz.php">μακάμ Χιτζάζ</a> (στην πραγματικότητα Χιτζασκάρ, ο τίτλος είναι λάθος), βιντεοσκοπημένο στο Μητροπολιτικό Μουσείο της Νεας Υόρκης, 1987.
                                    </span>
                                </div>
                            </label>
                        </div>
