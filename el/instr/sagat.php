            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3 mobile-left">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/sagat.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Σαγκάτ (Σατζάτ)</a>
                    </div>
                    <div class="text-center mt-2 mb-3 mobile-left">
                    ...
                    <p>
                        Τα Σαγκάτ (εκτός Αιγύπτου λέγονται Σατζάτ) είναι χάλκινα κύμβαλα δακτύλων με διάμετρο 1.5 το 2 ίντσες (υπάρχουν και  μεγαλύτερα κύμβαλα σε διπλάσια διάμετρο και λέγονται Τούρα). Φοριούνται στον αντίχειρα και στο μεσσαίο δάκτυλο απο κάθε χέρι χρησιμοποιόντας ελαστικά σχοινάκια. Τα Σαγκάτ καμιά φορά λέγονται και Ζήλια από την Τουρκική ονομασία "zills".
                    </p>
                    <p>
