...
$page_title = "Το Κανονάκι";
$page_description = "Το Κανονάκι";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3 mobile-left">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/qanun.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Κανονάκι</a>
                    </div>
                    <p>
