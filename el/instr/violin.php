                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=_ZWvLygSqkY&t=0s">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Σάμι Αλ-Σάουα </b>
                                    <span>Ένας από τους πιο σημαντικούς Άραβες βιολιστές των αρχών του 20ου αιώνα, ο Σύριος Σάμι Αλ-Σάουα (γνωστός και ως ο πρίγκηπας του βιολιού) παίζει <a href="../form/improv.php#taqsim">τακασίμ</a> σε <a href="../maqam/hijazkar.php">Μακάμ Χιτζάζ Κάρ</a>.
                                </span>
                                </div>
                            </label>
                        </div>
