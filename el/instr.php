...
$page_keywords = "Μακάμ, Τζινς, Ρυθμοί, Φόρμες, Mουσικά Όργανα, Δημοσιεύσεις, Το Ούτι, Το Κανονάκι, Το Νάι, Το Αραβικό Bιολί, Το Μπούζουκ, Το Αραβικό Ακκορντεόν, H Hλεκτρική Κιθάρα, To Αραβικό Οργανο, To Αραβικό Αρμόνιο, To Αραβικό Πιάνο, Το Σαξόφωνο, Η Τρομπέτα, Το Ρεκ, Η Τάμπλα, Το Ταμπλ Μπάλαντι , Το Νταφ, Το Αιγυπτιακό Μάζχαρ, Το Κάτεμ, Τα Σαγκάτ";
$page_language = "el";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p id="takht">
                        Το τυπικό παραδοσιακό Αραβικό μουσικό σύνολο ονομάζεται Ταχτ και αποτελείται από τεσσερα κυρίως όργανα: το <a href="instr/oud.php">ούτι</a>, το <a href="instr/nay.php">νάι</a>, το <a href="instr/qanun.php">κανονάκι</a> και το <a href="instr/violin.php">βιολί</a>, και ένα βασικό κρουστό: το <a href="instr/riqq.php">ρεκ</a>. Κάποιες φορές το ρεκ αντικαθίσταται/συμπληρώνεται με την <a href="instr/tabla.php">τάμπλα</a> (όρος συχνά χρησιμοποιημένος αντί τoν όρο νταρμπούκα ή ντούμπεκ. Μην το συγχέετε με την Ινδική τάμπλα) ή το <a href="instr/daff.php">νταφ</a> (είδος μπεντίρ), και τα μελωδικά όργανα μπορούν να συμπληρωθούν με το <a href="instr/buzuq.php">μπούζουκ</a>.
                    </p>

                    <p>
                        Στυλιστικά, τα μελωδικά όργανα χωρίζονται σε δύο οικογένειες τεχνικών χαρακτηριστικών: <em>Σαχμπ</em> (όργανα που παραγουν νότες διαρκείας), όπως το βιολί και το νάι, και <em>Νακρ</em> (νυκτά), όπως το ούτι και κανονάκι. 
                        Οι δύο αυτές οικογένειες αλληλοσυμπληρώνουν η μία την άλλη ώστε το ηχητικό αποτελεσμα να είναι πλουσιότερο και πιο ολοκληρωμένο.
                    </p>

                    <p>
                        Αραβοποιημένα όργανα είναι τα μη-Αραβικά όργανα που εισήλθαν στην Αραβική μουσική τον εικοστό αιώνα και γίνανε μέρος του Αραβικού ήχου εκείνης της εποχής. 
                        Τα περισσότερα από αυτά τα όργανα υπήρξαν καινοτόμα στην Αίγυπτο, όπου οι μουσικοί ανέπτυξαν νέες μορφές μελωδικής διάνθισης και τεχνικής που κάναν αυτά τα όργανα να ακούγονται εντελώς Αράβικα.
                        Κάποια αραβοποιημένα όργανα υπέστησαν τεχνική διαφοροποίηση κατασκευαστικά ώστε να προσαρμοστούν στο απαιτούμενα Αραβικά διαστήματα. 
                        Άλλα οργανα, λόγω αδυναμίας τεχνικής παρέμβασης παρέμειναν ως έχουν με το 12τονο ισοσκελισμένο τρόπο με τον οποίο κατασκευάστηκαν εξ αρχής.
		              </p>

                    <p>
                        Σε αυτα συμπεριλαμβάνονται το <a href="instr/piano.php">πιάνο</a>, το ηλεκτρικό πιάνο, το <a href="instr/org.php">ηλεκτρικό όργανο</a> ή αρμόνιο, το <a href="instr/keyboard.php">Oriental keyboard</a>, το <a href="instr/accordion.php">ακκορντεόν</a>, η <a href="instr/guitar.php">ηλεκτρική κιθάρα</a>, και το ηλεκτρικό ταστομένο μπάσσο. 
                        Κάποια από αυτά τα όργανα μπορούν να προσαρμοστούν και να παράγουν τέταρτα του τόνου. Η ντραμς και τα ηλεκτρονικά κρουστά επίσης χρησιμοποιούνται κοινώς σε πιο μοντέρνα Αραβική ποπ/χορευτική μουσική.
                    </p>

                    <p>
                        Το φλάουτο, <a href="instr/saxophone.php">σαξόφωνο</a>, κλαρινέτο και <a href="instr/trumpet.php">τρομπέτα</a> δεν εχουν απο την φύση λειτουργίας τους περιορισμό του 12τονου διαχωρισμού και έτσι επιτρέπουν μεγαλύτερο έλεγχο πάνω στο κούρδισμα σε σχέση με τα υπόλοιπα δυτικά όργανα. Αυτα τα όργανα χρησιμοποιούνται σε ποικίλες επεκτάσεις στυλιστικές, ειδικά σε μοντέρνα Αραβικά <em>Jazz Fusion</em> είδη.
                    </p>
