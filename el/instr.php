            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        ...
                        Άλλα οργανα, λόγω αδυναμίας τεχνικής παρέμβασης παρέμειναν ως έχουν με το 12τονο ισοσκελισμένο τρόπο με τον οποίο κατασεκυάστηκαν εξ αρχής.
		              </p>

                    <p>
                        Σε αυτα συμπεριλαμβάνονται το <a href="instr/piano.php">πιάνο</a>, το ηλεκτρικό πιάνο, το <a href="instr/org.php">ηλεκτρικό όργανο</a> ή αρμόνιο, το <a href="instr/keyboard.php">Oriental keyboard</a>, το <a href="instr/accordion.php">ακκορντεόν</a>, η <a href="instr/guitar.php">ηλεκτρική κιθάρα</a>, και το ηλεκτρικό ταστωμένο μπάσσο. 
                        Κάποια από αυτά τα όργανα μπορούν να προσαρμοστούν και να παράγουν τέταρτα του τόνου. Η ντραμς και τα ηλεκτρονικά κρουστά επίσης χρησιμοποιούνται συχνά σε πιο μοντέρνα Αραβική ποπ/χορευτική μουσική.
                    </p>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Παραδοσιακά</h5>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">δυτικά Αραβοποιημένα</h5>
