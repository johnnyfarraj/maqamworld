...
<ul class="sub-menu">
    ...
    <li><a href="/el/form/vocal_comp.php#dawr">Ντάουρ</a></li>
    <li><a href="/el/form/instr_comp.php#darij">Ντάριτζ</a></li>
    <li><a href="/el/form/vocal_comp.php#duet">Ντουέτο</a></li>
    <li><a href="/el/form/instr_comp.php#dulab">Ντουλάμπ</a></li>
    <li><a href="/el/form/vocal_comp.php#wasla">Ουάσλα</a></li>
    <li><a href="/el/form/vocal_comp.php#ughniya">Ουγνία</a></li>
    <li><a href="/el/form/ottoman.php#samai">Σαμάι</a></li>
    <li><a href="/el/form/improv.php#taqsim">Τακσίμ</a></li>
    <li><a href="/el/form/vocal_comp.php#taqtuqa">Τακτούκα</a></li>
    <li><a href="/el/form/instr_comp.php#tahmila">Ταχμίλα</a></li>
</ul>
