            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="heading">
                        ...
                        <h3>
                            Ο Κόσμος των Μακάμ είναι μια διαδικτυακή πηγή πληροφοριών αφιερωμένης στην διδασκαλία και μετάδοση του τροπικού συστήματος των Αραβικών μουσικών δρόμων (μακάμ), οι οποίοι είναι τα θεμέλια της Αραβικής παραδοσιακής μουσικής. Ο παρών ιστότοπος καλύπτει κυρίως μουσική από το μέρος του Αραβικού κόσμου όπως αυτό εκτείνεται κατά μήκος της Ανατολιτικής Μεσoγείου (Αίγυπτος, Παλαιστίνη, Ιορδανία, Λίβανος και Συρία), με εστίαση χρονικά από τις αρχές στα μέσα του εικοστού αιώνα.
                        </h3>
                    </div>

                    <p>
                        Μετά από 17 χρόνια λειτουργίας, o Κόσμος των Μακάμ έχει αναβαθμιστεί με την οικονομική υποστήριξη μέσω χορήγησης για το 2016 από τον ανεξάρτητο πολιτιστικό οργανισμό <a href="http://arabculturefund.org/grantees/grantee.php?id=333" target="_blank">The Arab Fund for Arts and Culture (AFAC)</a>. Ο Κόσμος των Μακάμ συμπεριλαμβάνει τα εξής νέα χαρακτηριστικά:
                    </p>
                    ...
                    <ul>
                        ...
                        <li>Ανανεωμένο και εμπλουτισμένο υλικό με πιο συναφή περιεχόμενο.</li>
                        <li>Υψηλότερη ανάλυση εικόνων και ποιότητας ηχητικών δειγμάτων.</li>
                        <li>Καλύτερη πλοήγηση κυρίου και δευτερευόντων περιεχομένων.</li>
                        <li>Νότες με δυνατότητα παραγωγής ήχου μέσω κλικ.</li>
                        <li>Ξεχωριστή σελίδα επικοινωνίας για αποδοχή σχολίων των αναγνωστών.</li>
                    </ul>

                    <p>
                        Εάν σας αρέσει αυτός ο ιστότοπος, παρακαλούμε ρίξτε μια ματιά στο συνοδευτικό του βιβλίο <a href="book.php">INSIDE ARABIC MUSIC</a>, σε μια από κοινού συγγραφική δουλειά με τον φίλο μου Σάμι Αμπού Σουμάις (δημιουργό του <a href="http://maqamlessons.com" target="_blank">MaqamLessons</a>).
                        Το βιβλίο θα αποτελεί μία περιεκτική αναφορά πάνω στην Αραβική μουσική και έχει εκδοθεί από το <a href="https://global.oup.com/academic/product/inside-arabic-music-9780190658366" target="_blank">Oxford University Press</a> τον Αύγουστο του 2019.
                    </p>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Μάθετε για το Αραβικό μουσικό τροπικό σύστημα με χρήση πενταγράμμου και ηχητικά παραδείγματα.
                                    </p>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Μάθετε για Τζινς, την υπομονάδα των τρόπων με το οποίο χτίζεται κάθε <strong>μακάμ</strong>.
                                    </p>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Μάθετε για τις Αραβικές μουσικές φόρμες, <b>Καουάλεμπ</b>, που χρησιμοποιούνται στα τραγούδια και ορχηστρική μουσική, στις συνθέσεις και τους αυτοσχεδιασμούς.</p>
