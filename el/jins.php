            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/jins.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Τζινς/Αζνάς</a>
                    </div>
                    ...
                    <p>
                        Η τονική (βάση/δεσπόζων φθόγγος) ενός <em>Τζινς</em> είναι η νότα αναφοράς και έμφασης της μελωδίας, η νότα όπου η μελωδία θα καταλήξει. Αυτή είναι συνήθως η πρώτη νότα του <em>Τζινς</em>. Η νότα οδηγός είναι η αυτή αμέσως κάτω από την τονική ενός <em>Τζινς</em>. Το γαμάζ (κορυφή/ψηλότερη νότα του Τζινς/δεσπόζων φθόγγος) είναι η πιο εμφατική νότα της  μελωδίας (πέρα από την τονική), όπως επίσης και το πιο κοινό σημείο εκκίνησης ενός νέου <em>Τζινς</em> (η μεταφορά σε ένα νέο <em>Τζινς</em> ή <a href="maqam.php">μακάμ</a> ονομάζεται μετατροπία).
                    </p>
                    <p>
                        Το μέγεθος ενός <em>Τζινς</em> είναι το σύνολο των νοτών μεταξύ της τονικής και της νότας <em>γαμάζ</em>. Αυτές οι νότες λέγονται βασική δομή του <em>Τζινς</em>. Έξω από την βασική δομή (σε όποια πλευρά της) βρίσκονται οι νότες που είναι μέρος και στοιχεία του μελωδικού λεξιλογίου. Αυτές οι νότες λέγονται διαβατικές (υποβάσιμες). Η βασική δομή συν τις διαβατικές νότες φτιάχνουν την επεκταμένη διαδοχή νοτών του <em>Τζινς</em>.
                    </p>
                    <p>
                        Κάθε <em>Τζινς</em> δείχνει την βασική δομή δοσμένη σε μεγάλης χρονικής αξίας, με την τονική και <em>γαμάζ</em> νότα σε ολόκληρα (δεσπόζωντες φθόγγοι). Οι διαβατικές (υποβάσιμες) δίνονται σε μικρότερες αξίες, και μερικές φορές ένα <em>Τζινς</em> περιλαμβάνει πολλαπλές επιλογές για αλλίωση σε κάποιες από αυτές.
                    </p>
                    <p>
