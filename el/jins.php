        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Το μέγεθος ενός <em>Τζινς</em> είναι το σύνολο των νοτών μεταξύ της τονικής και της νότας <em>γαμμάζ</em>. Αυτές οι νότες λέγονται βασική δομή του <em>Τζινς</em>. Έξω από την βασική δομή (σε όποια πλευρά της) βρίσκονται οι νότες που είναι μέρος και στοιχεία του μελωδικού λεξιλογίου. Αυτές οι νότες λέγονται διαβατικές (υποβάσιμες). Η βασική δομή συν τις διαβατικές νότες φτιάχνουν την επεκταμένη διαδοχή νοτών του <em>Τζινς</em>.
                    </p>
                    <p>
                        Κάθε <em>Τζινς</em> δείχνει την βασική δομή δοσμένη σε μεγάλης χρονικής αξίας, με την τονική και <em>γαμμάζ</em> νότα σε ολόκληρα (δεσπόζωντες φθόγγοι). Οι διαβατικές (υποβάσιμες) δίνονται σε μικρότερες αξίες, και μερικές φορές ένα <em>Τζινς</em> περιλαμβάνει πολλαπλές επιλογές για αλλίωση σε κάποιες από αυτές.
                    </p>
                    <p>
