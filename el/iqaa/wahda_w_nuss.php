            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda_w_nuss.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ουάχντα ου Νος</a>
                    </div>
                    ...
                    <p>
                        Το Ικά Ουάχντα ου Νος (σημαίνει “μία και μισή” στα Αραβικά) είναι ένας ρυθμός με συγκοπές και μία εκδοχή του <a href="maqsum.php">Ικά Μακσούμ</a> με πρώτο το <strong>Τακ</strong> καθυστερημένο κατά ένα δέκατο έκτο σε αξία από την κανονική του θέση. Είναι πολύ διαδεδομένος ρυθμός στο ύφος Τάραμπ του στα μέσα του εικοστού αιώνα.
                    </p>
