            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        ...
                        <h3>(επίσης προφέρεται και Ζαραφάτ)</h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Ευρετήριο Ρυθμοί</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/dharafat.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Δαραφάτ</a>
                    </div>
                    ...
                    <p>
                        Το Ικά Δαραφάτ (επίσης προφέρεται και Ζαραφάτ) χρησιμοποιείται περισσότερο στο φωνητικό είδος των <a href="../form/vocal_comp.php#muwashah">Μουασαχάτ</a>. Χρησιμοποιώντας αυτόν τον ρυθμό πέρα από τα Μουασαχάτ (π.χ. σε ένα λαϊκό τραγούδι) αυτό έχει ως αποτέλεσμα την προσθήκη μίας αίσθησης κλασσικής μορφής θυμίζοντας το πρότερο ρεπερτόριο.
                    </p>
