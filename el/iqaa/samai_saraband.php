            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/samai_saraband.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Σαμάι Σαραμπάντ</a>
                    </div>
                    ...
                    <p>
                        Το Ικά Σαμάι Σαραμπάντ, επίσης λέγεται και Σαμάι Τάερ (“τάερ” σημαίνει “ιπτάμενο” στα Αραβικά), είναι ένας ελαφρύς και γρήγορος ρυθμός ο οποίος είναι συχνός στο φωνητικό είδος <a href="../form/vocal_comp.php#muwashah">Μουάσαχ</a>.
                    </p>
