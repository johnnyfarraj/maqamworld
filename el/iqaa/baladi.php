            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/baladi.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Μπάλαντι</a>
                    </div>
                    ...
                    <div class="track" data-song="/audio/iqaa/baladi/halummu.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Ταλουμούνι ουα λαμ τάρθου λι χάλι</b>
