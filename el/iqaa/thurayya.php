            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/thurayya.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Θουράια</a>
                    </div>
                    
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/aqsaq_turki.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ακσάκ Τούρκι</a>
                    </div>
                    ...
                    <p>
                        Το Ικά Θουράια διαφορετικά λέγεται και <strong>Ακσάκ Τούρκι</strong>(τουρκικό Ακσάκ). Eίναι ένας πολύ σπάνιος ρυθμός, περισσότερο χρησιμοποιείται στο φωνητικό είδος <a href="../form/vocal_comp.php#muwashah">Μουάσαχ</a>.
                    </p>
                    ...
                    <div class="track " data-song="/audio/iqaa/thurayya/fattakatul-lahdhi.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1" >
                                <div class="info">
                                    <b>Μουάσαχ Φαττάκατου αλ-Λάχδι</b>
                                    <span>Καρίμ Άζαμπ (Παλαιστίνη)</span>
                                    <span>Μουσική Όμαρ αλ-Μπατς</span>
                                </div>
                            </label>
                        </div>
