            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda_kabira.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ουάχντα Καμπίρα</a>
                    </div>
                    
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda_sunbati.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ουάχντα Σουνμπάτι</a>
                    </div>
                    ...
                    <p>
                        Το Ικά Ουάχντα Καμπίρα (“Καμπίρα“ σημαίνει μεγάλη στα Αραβικά), επίσης γνωστό και ως <strong>Ούαχντα Σουνμπάτι</strong>, είναι μία εκδοχή του <a href="wahda.php">Ικά Ουάχντα</a> προσαρμοσμένη σε δύο μέτρα. Είναι ένας πολύ διαδεδομένος ρυθμός φωνητικής και ορχηστρικής μουσικής στα μέσα του εικοστού αιώνα.
                    </p>
