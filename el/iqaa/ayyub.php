            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/ayyub.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Αϊγιούμπ</a>
                    </div>
                    ...
                    <p>
                        Το Ικά Αϊούμπ (επίσης προφέρεται και Αγιούμπ) πρωτίστως χρησιμοποιείται στην Σούφικη μουσική, όπως επίσης και στον χορό της κοιλιάς (<em>Ρακς Σάρκι</em> - Belly Dance). To Αϊούμπ λέγεται μερικές φορές και Ζαρ στην Αίγυπτο, μετά από παραδοσιακή θεραπευτική τελετουργία οδηγούμενη από γυναίκες που παίζουν μεταφερόμενα στα χέρια κρουστά. Η αίσθηση του Αϊούμπ είναι γρήγορη, σύντομη και περιοδική.
                    </p>
