            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/dawr_hindi.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Ντάουρ Χίντι</a>
                    </div>
                    ...
                    <div class="track" data-song="/audio/iqaa/dawr_hindi/arji3i-ya-alfa-leila.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Μουάσαχ Άρζι Για Άλφα Λέιλα (1966)</b>
                                    <span>Φεϊρούζ (Λίβανος)</span>
                                    <span>Μουσική από τους αδερφούς Ραχμπάνι</span>
                                </div>
                            </label>
                        </div>
                    </div>
