...
$page_keywords = "Μακάμ, Τζινς, Ρυθμοί, Φόρμες, Mουσικά Όργανα, Δημοσιεύσεις, Το Ούτι, Το Κανονάκι, Το Νάι, Ντάουρ, Μουάσαχ, Καντ, Τακτούκα, Ουγνία, Κασίντα, Μονόλογο, Ντουέτο, Ντουλάμπ, Μακτούα, Μουκάντιμα, Ταχμίλα, Ντάριτζ, Σαμάι, Λόγκα, Μπάσραφ, Τακσίμ, Λαγιάλι, Μαουάλ, Κασίντα";
$page_language = "el";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Ως επί των πλείστων η παραδοσιακή και κλασσική  Αραβική μουσική, είτε στην σύνθεση ή τον αυτοσχεδιασμό, ακολουθεί μία γκάμα από φόρμες που λέγονται <em>Καουάλeμπ</em> στα Αραβικά (εν. <em>Κάλεμπ</em>, κυριολεκτικά σημαίνει πρότυπο ή σχηματισμένο δοχείο). Τα <em>Καουάλeμπ</em> είναι περιγράμματα που καθοδηγούν τον μουσικό και τον αυτοσχεδιαστή, και χρησιμοποιούνται τόσο στην μουσική με τραγούδι όσο και στην ορχηστρική μουσική. Τα <em>Καουάλeμπ</em> δίνουν στον μουσικό ένα γνώριμο περιβάλλον εργασίας, και δημιουργεί μία αίσθηση άνεσης και προσδοκίας στον ακροατή.
                    </p>

                    <p>
                        Τα <em>Καουάλeμπ</em> είναι oργανωμένα εδώ προς χάρην διευκόλυνσης σύμφωνα με τις φωνητικές/ορχηστρικές διαστάσεις και αυτές της σύνθεσης/αυτοσχεδιασμού.
                    </p>
