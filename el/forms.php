...
$page_keywords = "Μακάμ, Τζινς, Ρυθμοί, Φόρμες, Mουσικά Όργανα, Δημοσιεύσεις, Το Ούτι, Το Κανονάκι, Το Νάι, Ντάουρ, Μουάσαχ, Καντ, Τακτούκα, Ουγνία, Κασίντα, Μονόλογος, Ντουέτο, Ντουλάμπ, Μακτούα, Μουκάντιμα, Ταχμίλα, Ντάριτζ, Σαμάι, Λόγκα, Μπάσραφ, Τακσίμ, Λαγιάλι, Μαουάλ, Κασίντα";
$page_language = "el";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/qalab.mp3"><i class="fa fa-fw fa-volume-up"></i> Προφορά του Κάλεμπ/Καουάλεμπ</a>
                    </div>

                    <p>
                        Ως επί των πλείστων η παραδοσιακή και κλασσική  Αραβική μουσική, είτε στην σύνθεση ή τον αυτοσχεδιασμό, ακολουθεί μία γκάμα από φόρμες που λέγονται <em>Καουάλεμπ</em> στα Αραβικά (εν. <em>Κάλεμπ</em>, κυριολεκτικά σημαίνει πρότυπο ή σχηματισμένο δοχείο). Τα <em>Καουάλεμπ</em> είναι περιγράμματα που καθοδηγούν τον μουσικό και τον αυτοσχεδιαστή, και χρησιμοποιούνται τόσο στην μουσική με τραγούδι όσο και στην ορχηστρική μουσική. Τα <em>Καουάλεμπ</em> δίνουν στον μουσικό ένα γνώριμο περιβάλλον εργασίας, και δημιουργεί μία αίσθηση άνεσης και προσδοκίας στον ακροατή.
                    </p>

                    <p>
                        Τα <em>Καουάλεμπ</em> είναι oργανωμένα εδώ προς χάρην διευκόλυνσης σύμφωνα με τις φωνητικές/ορχηστρικές διαστάσεις και αυτές της σύνθεσης/αυτοσχεδιασμού.
                    </p>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Μάθετε σχετικά με το Ντάουρ, Μουάσαχ, Καντ, Τακτούκα, Ουγνία, Κασίντα, Μονόλογος και Ντουέτο.
                                    </p>
