        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>
                        Ως επί των πλείστων η παραδοσιακή και κλασσική  Αραβική μουσική, είτε στην σύνθεση ή τον αυτοσχεδιασμό, ακολουθεί μία γκάμα από φόρμες που λέγονται <em>Καουάλειμπ</em> στα Αραβικά (εν. <em>Κάλεμπ</em>, κυριολεκτικά σημαίνει πρότυπο ή σχηματισμένο δοχείο). Τα <em>Καουάλειμπ</em> είναι περιγράμματα που καθοδηγούν τον μουσικό και τον αυτοσχεδιαστή, και χρησιμοποιούνται τόσο στην μουσική με τραγούδι όσο και στην ορχηστρική μουσική. Τα <em>Καουάλειμπ</em> δίνουν στον μουσικό ένα γνώριμο περιβάλλον εργασίας, και δημιουργεί μία αίσθηση άνεσης και προσδοκίας στον ακροατή.
                    </p>

                    <p>
                        Τα <em>Καουάλειμπ</em> είναι oργανωμένα εδώ προς χάρην διευκόλυνσης σύμφωνα με τις φωνητικές/ορχηστρικές διαστάσεις και αυτές της σύνθεσης/αυτοσχεδιασμού.
                    </p>
