            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/fallahi.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Fallahi</a>
                    </div>
                    ...
                    <p>Iqa‘at Fallahi ist ein schneller ägyptischer Iqa‘, der für Volksmusik gut geeignet ist. Auch wenn er an einen doppelt so schnell gespielten <a href="maqsum.php">Maqsum</a> erinnert, hat er ein sehr anderes Feeling. Das liegt unter anderem daran, dass der Fallahi ziemlich dahinplätschert - ohne große Kontraste zwischen den <em>Dums</em> und <em>Taks</em>.</p>
                    ...
                    <div class="track " data-song="/audio/iqaa/fallahi/el_binti_beida.mp3">
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    <b>il-Benti Beida</b>
                                    <span>Musik mit Gesang von Metqal Qannawi</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Musik von Hassan Abu el-Su‘ud</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Ahmad Adaweya</span>
                                    <span>Musik von Faruq Salamah</span>
                                </div>
                            </label>
                        </div>
                    </div>
