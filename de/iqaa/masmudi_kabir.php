...
?>
  ...
  <body class="iqaas-page">
    ...
    <?php
      $page = "de/iqaa/masmudi_kabir.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/masmudi_kabir.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Masmudi Kabir</a>
                    </div>
                    ...
                    <p>Iqa‘ Masmudi Kabir (oder einfach nur Masmudi) ist einer der populärsten Rhythmen im Tarab-Repertoire des zwanzigsten Jahrhunderts. Das Wort "kabir" bedeutet groß auf Arabisch. Der Zusatz hilft, ihn vom <a href="baladi.php">Masmudi Saghir</a>, dem kleinen Masmudi (meist Baladi genannt) zu unterscheiden.</p>
