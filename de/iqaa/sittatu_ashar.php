            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/sittatu_ashar.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Sittatu ‘Ashar Masri</a>
                    </div>
                    ...
                    <p>Iqa‘ Sittatu 'Ashar Masri ("sittatu 'ashar" bedeutet sechzehn und "masri" heißt ägyptisch) ist ein seltener Iqa‘, der vor allem im vokalen <a href="../form/vocal_comp.php#muwashah">Muwashah</a>-Genre vorkommt. Er umfasst acht Viervierteltakte, bildet also einen Zweiunddreißigvierteltakt.</p>
