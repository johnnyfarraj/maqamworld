...
?>
  ...
  <body class="iqaas-page">
    ...
    <?php
      $page = "de/iqaa/nawakht_hindi.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>Iqa‘ Nawakht Hindi 16/6</h1>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Iqa‘-Verzeichnis</a>
                    <div class="clearfix"></div>
                    
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/nawakht_hindi.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Nawakht Hindi</a>
                    </div>
                    ...
                    <p>Iqa‘ Nawakht Hindi ist ein sehr häufiger Iqa‘ im <a href="../form/vocal_comp.php#muwashah">Muwashah</a>-Repertoire. Er wird gewöhnlich in gemächlichem Tempo gespielt.</p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Orchester und Chor des Tunesischen Rundfunks</span>
                                </div>
                            </label>
                        </div>
                    </div>
