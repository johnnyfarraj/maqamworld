            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/nawakht.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Nawakht</a>
                    </div>
                    ...
                    <p>Iqa‘ Nawakht ist ein sehr häufiger Iqa‘ im <a href="../form/vocal_comp.php#muwashah">Muwashah</a>-Repertoire. Er wird gewöhnlich in gemächlichem Tempo gespielt.</p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Musik mit Gesang von ‘Umar al-Batsh</span>
                                </div>
                            </label>
                        </div>
                    </div>
