            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/wahda_tawila.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Wahda Tawila</a>
                    </div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/wahda_sunbati.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Wahda Sunbati</a>
                    </div>
                    ...
                    <p>Iqa‘  Wahda Tawila ("tawila" ist das arabische Wort für lang) firmiert auch als <strong>Wahda Sunbati</strong>. Es handelt sich dabei um eine über zwei Takte gestreckte Version von <a href="wahda.php">Iqa‘ Wahda</a>. Diese ist in der Vokal- und Instrumentalmusik der Mitte des zwanzigsten Jahrhunderts sehr beliebt.</p>
