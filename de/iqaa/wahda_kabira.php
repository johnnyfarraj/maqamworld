            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        ...
                        <h3>(auch Wahda Sunbati)</h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Iqa‘-Verzeichnis</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda_kabira.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Wahda Kabira</a>
                    </div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda_sunbati.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Wahda Sunbati</a>
                    </div>
                    ...
                    <p>Iqa‘  Wahda Kabira ("kabira" ist das arabische Wort für groß) firmiert auch als <strong>Wahda Sunbati</strong>. Es handelt sich dabei um eine über zwei Takte gestreckte Version von <a href="wahda.php">Iqa‘ Wahda</a>. Diese ist in der Vokal- und Instrumentalmusik der Mitte des zwanzigsten Jahrhunderts sehr beliebt.</p>
                    ...
                    <div class="track" data-song="/audio/iqaa/wahda_kabira/tile3li_el_biki.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
