            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/mudawwar.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Awfar Masri</a>
                    </div>

                    <p>Iqa‘ Awfar Masri ist im <a href="../form/vocal_comp.php#muwashah">Muwashah</a>-Repertoire sehr verbreitet.</p>
                    <!-- TODO -->
                    <p>Its main two forms are described here.</p>

                    <br>
                    <div class="heading jins text-center">
                        <h3>Beispiele für die erste Form von Iqa‘ Awfar Masri</h3>
                    </div>
                    <div class="clearfix"></div>
                    <br>
                    ...
                    <br>
                    <div class="heading jins text-center">
                        <h3>Beispiele für die zweite Form von Iqa‘ Awfar Masri</h3>
                    </div>
                    <div class="clearfix"></div>
                    <br>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>(im <a href="../maqam/saba.php">Maqam Saba)</a></span>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>(im <a href="../maqam/nikriz.php">Maqam Nikriz)</a></span>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>(im <a href="../maqam/nahawand.php">Maqam Nahawand)</a></span>
