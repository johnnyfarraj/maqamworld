            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/samai_darij.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Sama‘i Darij</a>
                    </div>
                    ...
                    <p>Iqa‘ Sama‘i Darij (oft auch einfach nur Darij genannt) ist ein genereller Dreivierteltakt-Iqa‘. Er wird in lokaler und instrumentaler Musik verwendet. </p>
