            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        ...
                        <h3>Eine Kombination von <a href="kurd.php">Jins Kurd</a> und <a href="nikriz.php">Jins Nikriz</a></h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Jins-Verzeichnis</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/athar_kurd.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Athar Kurd</a>
                    </div>
                    ...
                    <p>Jins Athar Kurd ist ein Fünfton-Jins. Es ist hier notiert mit C als Tonika und G als Ghammaz. Jins Athar Kurd ist das erste Jins in <a href="../maqam/athar_kurd.php">Maqam Athar Kurd</a>.
                    </p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Musik von Yussef Shawqi</span>
                                </div>
                            </label>
                        </div>
                    </div>
