            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>Jins Sazkar</h1>
                        <h3>Eine Variante von <a href="rast.php">Jins Rast</a> mit erhöhter Sekunde</h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Jins-Verzeichnis</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/sazkar.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Sazkar</a>
                    </div>
                    ...
                    <p>Jins Sazkar ist ein Fünfton-Jins. Es ist hier notiert mit C als Tonika und G als Ghammaz. Jins Sazkar ist das erste Jins im <a href="../maqam/kirdan.php">Maqam Sazkar</a>.
                    </p>
