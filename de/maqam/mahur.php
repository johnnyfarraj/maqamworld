  ...
  <body class="maqams-page">
    ...
    <div class="page">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/mahur.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Mahur</a>
                    </div>
	  ...
	  <area shape="circle" coords="599,138,13" href="#" alt="C4" class="playNote" data-frequency="260.74" data-parent="#notation1"><!--tonic-->
                    ...
                    <p>Maqam Mahur beginnt mit Wurzel-<a href="../jins/rast.php">Jins Rast</a> auf der Tonika. Es folgt <a href="../jins/upper_ajam.php">Jins Ober-‘Ajam</a> auf der fünften Stufe (mit seiner Tonika auf der achten Stufe).
                    </p>
