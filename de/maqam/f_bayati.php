...
$page_title = "Maqam-Bayati-Familie";
$page_description = "Maqam-Bayati-Familie";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading text-center jins">
                        <h1>Maqam-Bayati-Familie</h1>
                        <h3>Maqamat, die mit <a href="../jins/bayati.php">Jins Bayati</a> beginnen</h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Maqam-Verzeichnis</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/bayati.mp3"><i class="fa fa-fw fa-volume-up"></i> Aussprache von Bayati</a>
                    </div>

                    <p>Die Maqam-Bayati-Familie besteht aus Maqamat, die mit <a href="../jins/bayati.php">Jins Bayati</a> beginnen.</p>
