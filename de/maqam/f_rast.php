...
$page_title = "Maqam-Rast-Familie";
$page_description = "Maqam-Rast-Familie";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading text-center jins">
                        <h1>Maqam-Rast-Familie</h1>
                        <h3>Maqamat, die mit <a href="../jins/rast.php">Jins Rast</a> beginnen </h3>
                    </div>
