        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1 ml-auto">
                    ...
                    <h5>للموسيقى العربية الكلاسيكية (التقليدية) سواء كانت مؤلفة أو مرتجلة قوالب من ناحية البُنية (جمع مفرده قالَب أي صيغة أو تركيب). فالقالب عبارة عن صيغة يبني المؤلف أو العازف عليها، فهي تستخدم في الموسيقى الغنائية والآلية على حدٍ سواء. والقالب يعطي للموسيقي شكلاً يحدد مسار عمله	الإبداعي ومساراً مُتفقٌ عليه من ناحية التركيب.
                    </h5>
