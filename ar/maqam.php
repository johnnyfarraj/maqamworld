        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1 ml-auto">
                    ...
                    <h5 >
المقام العربي هو نظام من سلالم وجُمل موسيقية معتادة وانتقالات مألوفة وزخارف تقليدية وجماليات مُتّبعة ومُتّفق عليها تُكوِّن بمجموعها تقليداً فنياً وتراثاً غنياً. ويُدعى التطور النغمي في سياق المقام ( سواء كان اللحن مؤلفاً او مرتجلاً) بالسير.
                    </h5>
                    <h5 >
يتم بناء سُلّم المقام بربط قطعتين او ثلاثة قطع سُلّمية (تسمّى بالجنس) على شكل سلسلة. وبذلك يكتسب المقام مسافاته وسلوكه النغمي وطبعه العام من الأجناس المكونة له.  يبدأ سُلّم المقام دائماً بالجنس الاول (من درجة القرار، وهي الدرجة الاولى)، ثم يتبعه الجنس الثاني بحيث يقع قراره على غمّاز (نقطة انتقال) الجنس الاول (والغمّاز عادةً ما يكون آخر درجة في سلّم الجنس). واذا استُعمل جنس ثالث فيقع قراره على غمّاز الجنس الثاني، وهكذا دواليك.
                    ...
                    <h5 >
يُعرّف ويُدرّس المقام في معظم المراجع الموسيقية ابتداءاً من سُلّمه الموسيقي. وتسمّى درجته الاولى بالقرار (حاله حال الجنس) وله درجة تُسمّى بالغمّاز وهي غمّاز الجنس الاول ونقطة انطلاق الجنس الثاني. اما الدرجة الادنى من القرار فتسمّى بالحساس.
                    </h5>
                    <h5 >
وعادةً ما يتألف سلّم المقام من سبع درجات تتكرر ابتداءاً من الدرجة الثامنة اللتي تسمّى بالجواب، باستثناء بعض المقامات اللتي تمتد الى ما بعد الدرجة الثامنة، او مقامات اخرى لا تتساوى فيها الدرجات الاولى والثامنة.  
                    </h5>
                    <h5 >
...
يمكنكم استطلاع المقامات فردياً (عن طريق دليل المقامات) أو من خلال العائلة التي تتنمي إليها:  
	          ...
	          <h5 >وفيما يلي المقامات المتبقّية التي لا تشترك بجنسها الاول مع اي مقامات اخرى، وبذلك فهي لا تنتمي لآي عائلة مقامية:</h5>
