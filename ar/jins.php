...
والجنس هو الوحدة النغمية الاساسية في الموسيقى العربية، اذ ان المقامات ليست الا سكك او مسالك لمجموع اجناسها المكوِّنة لها.
يعرّف الجنس بأبعاده الموسيقية التي لا تتغير في حال تصويره على درجات مختلفة، وهذه الابعاد تعطي لكل جنس طابعه وشخصيته المميزة.
                    </h5>
                    <h5>
...
وتستعمل علامات الزمن الكامل (اي المستديرة) لإظهار درجتي القرار والغمّاز.
                    </h5>
                    <h5>
يمكنكم استطلاع الاجناس فردياً عن طريق دليل الاجناس (المرتب ابجدياً) او عن طريق الجدول ادناه (المرتب حسب حجم الجنس):
                    </h5>
					<br>
                    ...
                    <div class="page-list-area">
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <ul class="page-list">
                                    <li><a href="jins/mustaar.php">مُستعار</a></li>
                                    <li><a href="jins/sikah.php">سيكاه</a></li>
                                </ul>
                            </div>
                            <div class="col-sm-3">
                                <div class="page-list-header">٤ علامات</div>
                                <ul class="page-list">
                                   <li><a href="jins/bayati.php">بياتي</a></li>
                                   <li><a href="jins/hijaz.php">حجاز</a></li>
                                   <li><a href="jins/hijaz_murassaa.php">حجاز مرصّع</a></li>
                                   <li><a href="jins/kurd.php">كُرد</a></li>
                                   <li><a href="jins/lami.php">لامي</a></li>
                                   <li><a href="jins/upper_ajam.php">عجم اعلى</a></li>
                                   <li><a href="jins/upper_rast.php">راست اعلى</a></li>
                                </ul>
                            </div>
                            <div class="col-sm-3">
                                <div class="page-list-header">٥ علامات</div>
                                <ul class="page-list">
                                    <li><a href="jins/ajam.php">عجم</a></li>
                                    <li><a href="jins/ajam_murassaa.php">عجم مرصّع</a></li>
                                    <li><a href="jins/athar_kurd.php">أثر كرد</a></li>
                                    <li><a href="jins/jiharkah.php">جهاركاه</a></li>
                                    <li><a href="jins/nahawand.php">نهاوند</a></li>
                                    <li><a href="jins/nikriz.php">نكريز</a></li>
                                    <li><a href="jins/rast.php">راست</a></li>
                                    <li><a href="jins/sazkar.php">سازكار</a></li>
                                </ul>
                            </div>
                            <div class="col-sm-3">
                                <div class="page-list-header">(حجم غير محدّد)</div>
                                <ul class="page-list">
                                    <li><a href="jins/hijazkar.php">حجاز كار</a></li>
                                    <li><a href="jins/mukhalif_sharqi.php">مخالف شرقي</a></li>
                                    <li><a href="jins/nahawand_murassaa.php">نهاوند مرصّع</a></li>
                                    <li><a href="jins/saba.php">صَبا</a></li>
                                    <li><a href="jins/saba_dalanshin.php">صَبا دَلَنشين</a></li>
                                    <li><a href="jins/saba_zamzam.php">صَبا زَمزَم</a></li>
                                    <li><a href="jins/sikah_baladi.php">سيكاه بلدي</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
