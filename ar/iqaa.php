            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1 ml-auto">
                    ...
                    <div class="heading text-center jins">
                        <h1>الايقاعات</h1>
                        <h3>ضربات تكرارية من  صوتيّ الدُمّ والتَكّ الاساسيين</h3>
                    </div>
...
وتتألف ضربات الايقاع من صوتي الدُمّ والتَكّ الاساسيين، فصوت الدُمّ عميق وممتدّ زمنياً الى حد ما ويمثّل الضغط القوي، اما صوت التَكّ فهو حادّ وجافّ ويمثل الضغط الضعيف.
 ويتألف كل طقم ايقاعي من ضربات الدُمّ والتَكّ، تتخللهما بعص الفراغات الزمنية (سكتات)  تُدعى الإِسّ.
                    </h5>
                    <h5>
ويُدوّن كل ايقاع بطقمٍ او مازورة نموذجية واحدة تُبيّن ضربات الدُمّ والتَكّ والإِسّ. وغالباً ما تتضمن الاغنية او المعزوفة ايقاعات متعددة بحيث يُستعمل كل ايقاع لعدد معين من المازورات ثم ينتقل الى ايقاعٍ آخر.
                    </h5>
                    <h5>
اما خلال الاداء، فعلى عازف الايقاع ان يزيّن الطقم النموذجي بمزيد من الضربات والزخارف التقليدية، وهو ما يُعرف بالتشكيل
 (اي إضافة التفاصيل، كما في الكتابة العربية). والتشكيل يعتمد على النوع او اللون الموسيقي، وعلى اسلوب التوزيع الآلي
 المرغوب، وعلى امكانيات الآلة الايقاعية نفسها، وعلى الآلات الايقاعية المرافقة -إن وجدت- ، واخيراً على ذوق وخبرة العازف.
                    </h5>
                    <h5>
يُعرّف الايقاع، بالاضافة الى اسمه، بوزن او مقياس يُدوَّن في الطقم النموذجي على شكل كَسر،
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <ul class="page-list">
                                    ...
                                    <li><a href="iqaa/nawakht_hindi.php">نواخت هندي ١٦/٤</a></li>
