        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1">
                    ...
                    <p>Iqa‘ Mukhammas is mostly confined to the Muwashah repertoire. Unrelated to its time signature, the word "mukhammas" in Arabic means based on the number 5.</p>
