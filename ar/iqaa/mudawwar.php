        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1">
                    ...
                    <p>Iqa‘ Mudawwar is a popular iqa‘ in the Muwashah repertoire. Many Mudawwar pieces start from the 11<sup>th</sup> beat (the last <em>tak</em>). The word "mudawwar" in Arabic means round/circular.</p>
