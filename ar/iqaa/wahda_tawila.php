            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/wahda_tawila.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of Wahda Tawila</a>
                    </div>
                    ...
                    <p>Iqa‘ Wahda Tawila ("<em>tawila</em>" is Arabic for long), also known as <strong>Wahda Sunbati</strong>, is a stretched out version of <a href="wahda.php">Iqa‘ Wahda</a> over two measures. It is very popular in the vocal and instrumental music of the mid-twentieth century.</p>
