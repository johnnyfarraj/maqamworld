            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/awis.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of ‘Awis</a>
                    </div>
                    ...
                    <p>Iqa‘ ‘Awis is mostly used with the Muwashshah genre. Some ‘Awis pieces start from the 3<sup>rd</sup> beat (the first <em>tak</em>), like for example muwashah "Munyati Man Rumtu Qurbuhu". Meanwhile muwashah "Hibbi Da‘ani Lil-Wisal" starts the melody on the 11<sup>th</sup> beat (the last <em>tak</em>).
                    </p>
