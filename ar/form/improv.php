...
?>
 ...
 للمطربة السورية ماري جبران (تلحين محمد عثمان) يبدأ بتقسيم على القانون وتليه ليالي في مقام النهاوند
                                    </span>
                                </div>
                            </label>
                        </div>
   ...
   للمطرب المصري صالح عبد الحي (من تلحين رياض السنباطي) في قالب وصلة في مقام الراست تبدأ بتقسيم على العود،
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>يبدأ المطرب الحلبيّ محمد خيري وصلة في مقام الراست بقالب الليالي تتبعه قصيدة مرسلة ثمّ بعض القدود.
                                    </span>
                                </div>
                            </label>
                        </div>
                    ...
                    <h5>الموال (مفرد جمعه مواويل) هو غناء مرتجل يستخدم المطرب فيه شعراً محكياً  (باللغة العامّية)،
                        فيمكن أن يكون الموال بالدارجة المصرية أو اللبنانية أو السورية أو العراقية.
                        وهو مثل باقي القوالب الغنائية المرتجلة وسيلة لاستعراض
                        <a href="../maqam.php">المقام</a>
                        وسيره من جهة،
                        ولإظهار جمال صوت المطرب ومهاراته من جهة ثانية.
                    </h5>
                    <h5>ومن أشيع المواويل الموال البغدادي أو ما يعرف بالسبعاوي (من كلمة سبعة)
                        لأنه يتألف من سبعة أشطر يتبع الشطر الأول والثاني والثالث والسابع قافية واحدة
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>يبدأ المطرب الحلبيّ محمد خيري وصلة في مقام البياتي بسماعيّ يليه المَوّال السبعاوي  صدّوك عني العدا.
                                    </span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    ...
                                    <span>قصيدة قل للمليحة يا من يرى ادمعي في مقام الراست، غناء المطرب الحلبي محمد خيري</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                ...
                                <span>قصيدة قل للمليحة في مقام الهزام، غناء المطرب الحلبي صباح فخري</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=-Atnx8aRrIg">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>عبّود عبد العال</b>
                                    <span> تقسيم على الكمنجة في مقام البياتي للاستاذ عبّود عبد العال،
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=7iB4JFYArFg">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>عامر عمّوري</b>
                                    <span> تقسيم على العود في مقام البياتي للاستاذ عامر عمّوري (سوريا)،
