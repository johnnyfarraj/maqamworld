            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1 ml-auto">
                    ...
                    <div class="image-with-caption">
                        ...
                        <span>كاتم ذو وجه بلاستيكي قابل للدوزان.
                            &copy; 
                            عالم المقامات.</span>
                    </div>
                    
                    <h5>الكاتم هو آلة دف كبيرة الحجم وذات صوت مكتوم وفظّ. عادة ما يضع العازف الكاتم بين ركبتيه ويعزف عليها بكامل اليد وليس بالأصابع فقط.
                        درج تركيب الوجوه البلاستيكية القابلة للدوزان على الكواتم في أيامنا هذه.
                        تُسند إلى الكاتم بشكل أساسي مهمة التركيز على علامات الدم والتك مع إضافة بعض الزخارف.
                    </h5>
                    <br>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=cU1uHX74qkE&t=0s">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>زفّة (حفلة عرس)</b>
                                    <span>حفلة زفة مصرية مع عدد كبير من الآلات الايقاعية فيها المزاهر المصرية والكواتم وجميعها ذات وجوه بلاستيكية.</span>
                                </div>
                            </label>
                        </div>
                    </div>
