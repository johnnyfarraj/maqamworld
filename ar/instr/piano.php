        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1 ml-auto">
                    ...
                    <h5>دخل البيانو على الموسيقى العربية منذ اوائل القرن العشرين، لكنه استعمل في البداية كآلة غربية بحت من اجل اضافة صوت غربي كلاسيكي الى التوزيع العربي
 			(مثلاً في اغنية الصِبا والجمال لمحمد عبد الوهاب من سنة ١٩٣٩).
 			لكن اهتمام هذه الفقرة يقتضر على البيانو الشرقي اي المستعل نغمياً فقط (دون اي تآلف) لعزف المقامات العربية.  
                    </h5>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=3v9u-h4Vr5A">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>عبد الله شاهين</b>
                                <span>عازف البيانو اللبناني عبد الله شاهين يعزف تقسيم في مقام الصبا تتبعه اغنية "باتت عيوني". (من اسطوانة انغام من الشرق)</span>
                                </div>
                            </label>
                        </div>
                    </div>
