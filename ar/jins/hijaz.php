...
?>
  ...
  <body class="rtl jins-page">
	...
	وعادةً ما تُرفع الدرجة الثانية وتُخفّض الدرجة الثالثة قليلاً بالنسبة لما هو مدوّن بحيث يصبح البعد بين تلك الدرجتين اقلّ من الصوت ونصف الصوت (في السّلم المعدّل).
