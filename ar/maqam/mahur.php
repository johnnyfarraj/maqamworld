        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 order-sm-1">
                    ...
                    <div class="notation">
                        <img src="/note/maqam/mahur.png" class="img-fluid">
                    </div>

                    <p>Maqam Mahur has <a href="../jins/upper_ajam.php">Jins Upper ‘Ajam</a> above <a href="../jins/rast.php">Jins Rast</a>, rather than <a href="../jins/upper_rast.php">Jins Upper Rast</a>.</p>
