...
$page_keywords = "عود,مقام نهاوند ,موسيقى عربية ,قانون, ناي, مقام, جنس, آلات, طرب, عالم المقامات, ايقاع";
$page_language = "ar";
  ...
  <body class="rtl maqams-page">
    ...
    <div class="page">
	  ...
	  <area shape="circle" coords="608,80,13" href="#" alt="دو" class="playNote" data-frequency="521.48" data-parent="#notation1">
		...
		يبدأ سلّم هذا المقام <a href="../jins/nahawand.php">بجنس النهاوند</a> (وهو جنس الأصل) على الدرجةا الاولى (القرار)،
