        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>Vous pouvez commencer à explorer des exemples de <em>iqa‘at</em> arabes en utilisant l'<strong>Indice del Iqa‘at</strong> (en ordre alphabétique) ou en utilisant le tableau ci-dessous (classé en ordre croissant selon le nombre de temps par mesure):
                    </p>
