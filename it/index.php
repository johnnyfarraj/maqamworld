        ...
        <div class="container">
            <div class="row align-items-center">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/it/iqaa.php" class="btn btn-primary">Rythme<i class="fa fa-fw fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
				...
				que ces dernières soient composées ou improvisées. </p>
                                    <a href="/it/forms.php" class="btn btn-primary">Formes<i class="fa fa-fw fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/it/instr.php" class="btn btn-primary">Instruments<i class="fa fa-fw fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">De l'information au sujet du livre 'Inside Arabic Music' (coécrit avec Sami Abou Shumays) dont la publication est prévue en Août 2019.</p>
                                    <a href="/it/book.php" class="btn btn-primary">Publications<i class="fa fa-fw fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
