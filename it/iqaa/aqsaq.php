            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/aqsaq.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronuncia di Aqsaq</a>
                    </div>
                    ...
                    <p>L'Iqa‘ Aqsaq è molto popolare nel genere vocale <a href="../form/vocal_comp.php#muwashah">Muwashah</a>. È di un battito più breve dell'<a href="samai_thaqil.php">Iqa‘ Sama‘i Thaqil</a> ma a volte può essere suonato subito dopo quest'ultimo iqa‘ senza interruzioni, durante un <a href="../form/vocal_comp.php#wasla">Wasla</a>.
					</p>
