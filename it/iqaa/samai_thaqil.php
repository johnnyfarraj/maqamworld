...
$page_keywords = "musica tradizionale araba, maqam, strumenti, forme, jins, iqa‘, sama‘i thaqil, iqaa, ritmo, oud, qanun, nay, quarti di tono, tarab";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/samai_thaqil.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronuncia di Sama‘i Thaqil</a>
                    </div>
