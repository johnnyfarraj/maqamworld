            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/baladi.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronuncia di Baladi</a>
                    </div>
                    ...
                    <p>L'Iqa‘ Baladi è un iqa‘ molto popolare nel repertorio vocale del vicino oriente arabo. È anche chiamato <strong>Masmudi Saghir</strong>, "saghir" che significa "piccolo" in arabo, per distinguerlo dal <a href="masmudi_kabir.php">Masmudi Kabir</a>, che è lungo due misure di 4/4 invece che una. Il Baladi modula frequentemente al <a href="maqsum.php">Maqsum</a> per tornare indietro, come anche al <a href="malfuf.php">Malfuf</a> (usando 2 misure di Malfuf e 1 misura di Baladi).
                    </p>
