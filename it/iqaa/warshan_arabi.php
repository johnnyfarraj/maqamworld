...
?>
  ...
  <body class="iqaas-page">
    ...
    <?php
      $page = "it/iqaa/warshan_arabi.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/warshan_arabi.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronuncia di Warshan ‘Arabi</a>
                    </div>
                    ...
                    <p>L'Iqa‘ Warshan ‘Arabi ("‘arabi" significa araba) è un iqa‘ raro usato principalmente nel genere vocale <a href="../form/vocal_comp.php#muwashah">Muwashah</a>. Dura 8 misure di 4/4, portando il suo tempo a un 32/4.
                    </p>
