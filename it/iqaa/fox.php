        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>L'Iqa‘ Fox (derivato probabilmente da "Foxtrot") è un iqa‘ semplice in 2/4 iqa‘ solitamente suonato senza molti arricchimenti sopra una sezione strumentale. Questo, e il fatto che sia spesso suonato in un tempo molto veloce, gli danno un senso di rapidità e urgenza. E' il principale iqa‘ usato nella forma strumentale Turca e dell'Europa orientale <a href="../form/ottoman.php#longa">Longa</a>. Il Fox può facilmente modulare al <a href="malfuf.php">Malfuf</a> e ritornare. Una versione molto lenta del  (vedi gli ultimi due esempi) può essere scritta in 4/4.</p>
