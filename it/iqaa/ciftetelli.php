            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/ciftetelli.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronuncia di Ciftetelli</a>
                    </div>
                    ...
                    <p>L'Iqa‘ Ciftetelli (pronunciato "sciaftatalli" in arabo) è un <em>usul</em> (iqa’ Turco) che è diventato popolare nella musica araba. È raramente usato per le melodie composte; invece, la sua funzione primaria, è quella di accompagnare le <a href="../form/improv.php">improvvisazioni</a> (sia vocali che strumentali).</p>

                    <p>Il Ciftetelli è solitamente un ritmo lento e allungato si due battute da 4/4 (vedi l'annotazione), e può condividere lo stesso tempo e ritmo con il <a href="masmudi_kabir.php">Masmudi Kabir</a>. In alternativa, può essere eseguito più veloce e leggero, in questo caso può essere segnato come 4/4 e diventare simile al <a href="wahda_w_nuss.php">Wahda wi Nuss</a> (con o senza degli arricchimenti).</p>
                    ...
                    <div class="track" data-song="/audio/iqaa/ciftetelli_4_4/taqsim_nay.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Taqsim al Nay sul Maqam Bayati</b>
                                    <span>Muhammad Khayri</span>
                                </div>
                            </label>
                        </div>
