...
$page_keywords = "musique arabe, maqam, instruments, jins sikah, iqa‘, iqaa, rythme, oud, qanun, nay, quart de ton, tarab";
$page_language = "it";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>Jins Sikah</h1>
                        <h3>Jins de base de la <a href="../maqam/f_sikah.php">Famiglia Maqam Sikah</a></h3>
                    </div>
                    ...
                    <p>Il Jins Sikah est un jins de 3 notes. Il est noté ici avec sa tonique sur Mi<i class='icon-halfflat'></i> et son <em>ghammaz</em> sur Sol. Il Jins Sikah est le premier jins du <a href="../maqam/sikah.php">Maqam Sikah</a>, du <a href="../maqam/huzam.php">Maqam Huzam</a>, du <a href="../maqam/iraq.php">Maqam ‘Iraq</a> et du <a href="../maqam/bastanikar.php">Maqam Bastanikar</a>.
                    </p>
