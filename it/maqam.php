    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9 col-sm-9">
          ...
          <p>Il Maqam Arabo (plurale <em>maqamat</em>) è un sistema di scale, frasi melodiche abituali, possibilità di modulazione, norme di abbellimento e convenzioni estetiche che insieme formano una ricca struttura melodica e una tradizione artistica. Il corso della melodia del <em>maqam</em> (sia nella musica composta che improvvisata) con questa struttura è chiamata <sayr>sayr</sayr> in Arabo.</p>

          <p>Ogni maqam può essere costruito unendo insieme due (o in alcuni casi tre) frammenti di scale o blocchi chiamati <a href="jins.php">jins</a> (plurale <em>ajnas</em>). Il <em>maqam</em> ottiene i suoi intervalli, il suo comportamento melodico e il suo "umore" dagli <em>ajnas</em> che lo costituiscono. Il primo jins inizia sempre il <em>maqam</em> con la sua tonica sul primo grado, e il secondo <em>jins</em> inizia sul <em>ghammaz</em> (punto di modulazione) del primo <em>jins</em> (che è di solito corrisponde con l'ultima nota). Se vi è anche un terzo jins la sua tonica coinciderà con il <em>ghammaz</em> del secondo jins e così via. La nota subito prima della tonica è chiamata leading tone.</p>
          ...
          <p>Secondo la tradizione, i <em>maqamat</em> sono classificati in famiglie in base al primo <em>jins</em> (la radice) che condividono. Il <em>jins</em> fondamentale ha un ruolo importante nel definire il carattere del <em>maqam</em>. Il <em>maqam</em> più popolare all'interno della famiglia di solito ha lo stesso nome del primo <em>jins</em>. Gli altri <em>maqamat</em> sono chiamati branch <em>maqamat</em>, e sono basati sull'uso di un secondo (upper) <em>jins</em>.</p>
