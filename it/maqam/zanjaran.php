            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/zanjaran.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronuncia di Zanjarane</a>
                    </div>
                    ...
                    <div class="track" data-song="/audio/maqam/zanjaran/fi-shar3i-min.mp3">
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    <b>Fi Shar‘i Min</b>
                                    <span>oce e musica di Sayyed Darwish</span>
                                </div>
                            </label>
                        </div>
                    </div>
