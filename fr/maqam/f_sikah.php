            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading text-center jins">
                        <h1>Famille du Maqam Sikah</h1>
                        <h3>Les Maqamat qui commencent par <a href="../jins/sikah.php">Jins Sikah</a></h3>
                    </div>
                    ...
                    <p>Famille du Maqam Sikah is made of <em>maqamat</em> that start with <a href="../jins/sikah.php">Jins Sikah</a>.</p>
