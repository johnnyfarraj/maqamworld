  ...
  <body class="maqams-page">
    ...
    <div class="page">
	  ...
	  <area shape="circle" coords="840,108,13" href="#" alt="G4" class="playNote" data-frequency="391.11" data-parent="#notation1">
	       ...
	       <p>Maqam ‘Ajam (also known as Egyptian ‘Ajam) is The principal maqam in the <a href="f_ajam.php">Maqam ‘Ajam Family</a>, and starts with the root <a href="../jins/ajam.php">Jins ‘Ajam</a> on the <em>tonic</em>, followed by either <a href="../jins/upper_ajam.php">Jins Haut ‘Ajam</a> on the 5<sup>th</sup> degree (with its tonic up on the 8<sup>th</sup> degree) or <a href="../jins/nahawand.php">Jins Nahawand</a> on the 5<sup>th</sup> degree.</p>
