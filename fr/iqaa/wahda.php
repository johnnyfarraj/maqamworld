...
$page_keywords = "musique arabe, mode arabe, maqam, jins, iqa‘, iqaa, rhythme, wahda, oud, qanoun, nay, quart de ton, tetrachorde, musique modale, moyen orient, tarab";
$page_language = "fr";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Wahda</a>
                    </div>
                    ...
                    <p>Le Iqa‘ Wahda est le <em>iqa‘</em> principal pour les phrases vocales du genre <em>tarab</em> du 20<sup>ième</sup> siècle. <em>Wahda</em> veut dire 'un' en arabe et réfère au seul <em>doum</em> de la mesure, ce qui laisse beaucoup de place au chanteur pour ornementer et lui donne aussi un certain contrôle pour la vitesse.</p>
