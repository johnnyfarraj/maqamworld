            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/aqsaq.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Aqsaq</a>
                    </div>
                    ...
                    <div class="track" data-song="/audio/iqaa/aqsaq_form1/el_sama3_wel_rah.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Mouachah el-Sama‘ ouel-Rah</b>
                                    <span>Ibrahim al-Haggar (Égypte)</span>
                                    <span>usique de Daoud Housni</span>
                                </div>
                            </label>
                        </div>
                    </div>
