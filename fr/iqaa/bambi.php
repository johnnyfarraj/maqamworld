...
$page_keywords = "musique arabe, mode arabe, maqam, jins, iqa‘, iqaa, rhythme, bambi, oud, qanoun, nay, quart de ton, tetrachorde, musique modale, moyen orient, tarab";
$page_language = "fr";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/bambi.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Bambi</a>
                    </div>
