...
$page_title = "Jins Saba Dalanchine";
$page_description = "Jins Saba Dalanchine";
$page_keywords = "musique arabe, maqam, instruments, jins saba dalanchine, iqa‘, iqaa, rythme, oud, qanoun, nay, quart de ton, tarab";
$page_language = "fr";
...
?>
  ...
  <body class="jins-page">
    ...
    <?php
      $page = "fr/jins/saba_dalanshin.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/saba_dalanshin.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Saba Dalanchine</a>
                    </div>
