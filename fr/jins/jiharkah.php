...
$page_keywords = "musique arabe, maqam, instruments, jins jiharkah, iqa‘, iqaa, rythme, oud, qanoun, nay, quart de ton, tarab";
$page_language = "fr";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/jiharkah.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Jiharkah</a>
                    </div>
