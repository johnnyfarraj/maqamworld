...
$page_title = "Jins Hijaz Mourassa";
$page_description = "Jins Hijaz Mourassa";
$page_keywords = "musique arabe, maqam, instruments, jins hijaz mourassaa, iqa‘, iqaa, rythme, oud, qanoun, nay, quart de ton, tarab";
$page_language = "fr";
...
?>
  ...
  <body class="jins-page">
    ...
    <?php
      $page = "fr/jins/hijaz_murassaa.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>Jins Hijaz Mourassa‘ <span class="badge badge-custom">New</span></h1>
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/hijaz_murassaa.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Hijaz Mourassa‘</a>
                    </div>
                    ...
                    <p>Jins Hijaz Mourassa‘ is a 4-note <em>jins</em>. It is notated here with its tonic on D and its <em>ghammaz</em> on G. Jins Hijaz Mourassa‘ is not part of any <em>maqam</em> scale and usually occurs as a modulation from <a href="hijaz.php">Jins Hijaz</a>, most in <a href="../maqam/hijazkar.php">Maqam Hijazkar</a>.
                    </p>
                    ...
                    <div class="track" data-song="/audio/jins/hijaz_murassaa/badru_timmin_oud.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Mouachah Badru Timmin (Oud Taqsim)</b>
                                    <span>Ghada Shbeir</span>
                                    <span>Musique de Sheikh Mursi al-Hariri</span>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Interprétation et Musique de Sheikh Mursi al-Hariri</span>
                                </div>
                            </label>
                        </div>
                    </div>
