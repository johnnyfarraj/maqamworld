            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/iqaa.mp3"><i class="fa fa-fw fa-volume-up"></i> Prononciation de Iqa‘/Iqa‘at</a>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <ul class="page-list">
                                    ...
                                    <li><a href="iqaa/nawakht_hindi.php">Nawakht Hindi 16/4</a></li>
                                    ...
                                    <li><a href="iqaa/warshan_arabi.php">Warchane ‘Arabi 32/4</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
