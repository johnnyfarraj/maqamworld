            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>O Iqa‘ Sittatu ‘Ashar Masri 32/4</h1>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Índice de Iqa‘at</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/sittatu_ashar.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Sittatu ‘Ashar Masri</a>
                    </div>
                    ...
                    <p>O Iqa‘ Sittatu ‘Ashar Masri ("sittatu ‘ashar" significa dezesseis, "masri" significa egípcio) é um <em>iqa‘</em> raro utilizado principalmente no gênero vocal <a href="../form/vocal_comp.php#muwashah">Muwashah</a>. Ele engloba 8 compassos de 4/4, de forma que sua fórmula de compasso seja 32/4.
                    </p>
