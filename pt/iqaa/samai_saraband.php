...
?>
  ...
  <body class="iqaas-page">
    ...
    <?php
      $page = "pt/iqaa/samai_saraband.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/samai_saraband.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Sama‘i Saraband</a>
                    </div>
