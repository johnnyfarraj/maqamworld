...
?>
  ...
  <body class="iqaas-page">
    ...
    <?php
      $page = "pt/iqaa/nawakht_hindi.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>O Iqa‘ Nawakht Hindi 16/4</h1>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Índice de Iqa‘at</a>
                    <div class="clearfix"></div>
                    
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/nawakht_hindi.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Nawakht Hindi</a>
                    </div>
                    ...
                    <p>O Iqa‘ Nawakht Hindi é um <em>iqa‘</em> muito popular no repertório <a href="../form/vocal_comp.php#muwashah">Muwashah</a>, e tende a ser executado em andamentos moderados.</p>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Orquestra e Coro da Rádio Tunisina</span>
                                </div>
                            </label>
                        </div>
                    </div>
