            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>O Iqa‘ Nawakht 7/4</h1>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Índice de Iqa‘at</a>
                    <div class="clearfix"></div>
                    
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/nawakht.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Nawakht</a>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Voz e música por Omar al-Batch</span>
                                </div>
                            </label>
                        </div>
                    </div>
