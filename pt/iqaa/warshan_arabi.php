...
?>
  ...
  <body class="iqaas-page">
    ...
    <?php
      $page = "pt/iqaa/warshan_arabi.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>O Iqa‘ Warshan ‘Arabi 32/4</h1>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Índice de Iqa‘at</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/warshan_arabi.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Warshan ‘Arabi</a>
                    </div>
                    ...
                    <p>O Iqa‘ Warshan ‘Arabi (<em>‘Arabi</em> significa “árabe”) é um iqa‘ raro usado principalmente no gênero vocal <a href="../form/vocal_comp.php#muwashah">Muwashah</a>. Ele engloba 8 compassos de 4/4, resultando em uma fórmula de compasso de 32/4.
                    </p>
