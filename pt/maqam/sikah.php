            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        <h1>Maqam Sikah</h1>
                        <h3>The principal maqam in the <a href="f_sikah.php">Maqam Sikah Family</a></h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Maqam Index</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/sikah.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Sikah</a>
                    </div>
                    ...
                    <p>Watch a 1-minute sample <a href="https://www.instagram.com/p/B-XUb5VFxVb" target="_blank">Violin Taqsim in Maqam Sikah</a> by Sami Abu Shumays.</p>
