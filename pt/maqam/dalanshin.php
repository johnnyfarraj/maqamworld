            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/dalanshin.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Dalanshin</a>
                    </div>
                    ...
                    <map name="notemap">
					  ...
					  <area shape="circle" coords="393,90,13" href="#" alt="Lá" class="playNote" data-frequency="440" data-parent="#notation1">
                    ...
                    <p>
                        O Maqam Dalanshin começa com o <a href="../jins/saba_dalanshin.php">Jins Saba Dalanshin</a> na oitava do <a href="rast.php">Maqam Rast</a>, e então transiciona de volta para a escala do <a href="rast.php">Maqam Rast</a> com o <a href="../jins/upper_rast.php">Jins Rast Alto</a>  no 5º grau (com sua tônica acima no 8º grau), e o <a href="../jins/rast.php">Jins Rast</a> na tônica.
                    </p>
			         <p>
                         Não há muitas canções neste maqam, mas ele é mais frequentemente usado como uma modulação do <a href="rast.php">Maqam Rast</a>.
                    </p>
