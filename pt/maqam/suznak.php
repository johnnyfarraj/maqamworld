            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/suznak.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronúncia de Suznak</a>
                    </div>
                    ...
                    <p>Watch a 1-minute sample <a href="https://www.instagram.com/p/B-UjmDDlZKq" target="_blank">Violin Taqsim in Maqam Suznak</a> by Sami Abu Shumays.</p>
                    ...
                    <div class="track" data-song="/audio/maqam/suznak/taqsim_qanun_salman.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Taqsim Qanoun in Maqam Suznak</b>
