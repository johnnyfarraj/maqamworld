            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3 mobile-left">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/name/riqq.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of Riqq</a>
                    </div>
                    ...
                    <div class="youtube-track" data-youtube="https://www.youtube.com/watch?v=Ptd3R51Qj-s&t=2100s">
                        <div class="radio">
                            <label>
                             ...
                             --><div class="info">
                                    <b>Hassan Anwar</b>
                                <span>Riqq player Hassan Anwar (the official <em>dabet al-iqa‘</em> for the Diamond Orchestra in Egypt) exchanges solos with the org player in Abdel Halim Hafez's song Qari'at al-Fingan (1976, music by Muhammad al-Mugi).</span>
                                </div>
                            </label>
                        </div>
                    </div>
