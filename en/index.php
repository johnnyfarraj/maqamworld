        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-12">
                    ...
                    <ul>
                        <li>A full translation to <a href="/ar/index.php"><strong>Arabic</strong></a>, <a href="/fr/index.php"><strong>French</strong></a> and <a href="/de/index.php"><strong>German</strong></a> (<a href="/it/index.php">Italian</a> and Spanish are under construction).</li>
                    ...
                    The book is entitled <a href="book.php">INSIDE ARABIC MUSIC</a>, and is expected to be published by <a href="https://global.oup.com/academic/product/inside-arabic-music-9780190658366" target="_blank">Oxford University Press</a> in August 2019.
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Learn about the upcoming book "Inside Arabic Music" (co-authored with Sami Abu Shumays) scheduled for release in August 2019.</p>
