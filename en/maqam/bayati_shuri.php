...
?>
  ...
  <body class="maqams-page">
    ...
    <?php
      $page = "en/maqam/bayati_shuri.php";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>Maqam Bayati Shuri is a variation of <a href="bayati.php">Maqam Bayati</a> with a raised 5<sup>th</sup> degree. It starts with the root <a href="../jins/bayati.php">Jins Bayati</a> on the <em>tonic</em> followed by <a href="../jins/hijaz.php">Jins Hijaz</a> on the 4<sup>th</sup> degree.</p>
