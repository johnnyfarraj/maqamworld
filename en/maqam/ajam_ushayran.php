...
?>
  ...
  <body class="maqams-page">
    ...
    <?php
      $page = "en/maqam/ajam_ushayran.php";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/ajam_ushayran.mp3"><i class="fa fa-fw fa-volume-up"></i>Pronunciation of ‘Ajam ‘Ushayran</a>
                    </div>
