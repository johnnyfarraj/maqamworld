            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/huzam.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of Huzam</a>
                    </div>
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/rahat_al_arwah`.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of Rahat al-Arwah</a>
                    </div>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    ...
                                    <span>Music and Vocals by Zakariya Ahmad</span>
                                </div>
                            </label>
                        </div>
                    </div>
