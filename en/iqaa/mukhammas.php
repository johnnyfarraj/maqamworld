            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/mukhammas.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of Mukhammas</a>
                    </div>
                    ...
                    <div class="track " data-song="/audio/iqaa/mukhammas/hadhi_al-manazel.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1" >
                                <div class="info">
                                    <b>Muwashah Hadhihi al-Manazil</b>
                                    <span>Sabah Fakhri and his ensemble</span>
