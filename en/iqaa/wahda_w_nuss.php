            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/wahda_w_nuss.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciation of Wahda w-Nuss</a>
                    </div>
                    ...
                    <p>Iqa‘ Wahda w-Nuss (meaning "one and a half" in Arabic) is a syncopated version of <a href="maqsum.php">Iqa‘ Maqsum</a> with a first <em>tak</em> delayed by half of an an eighth note. It is very popular in the Tarab genre of the mid-twentieth century.</p>
