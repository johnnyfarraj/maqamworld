            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="heading jins text-center">
                        ...
                        <h3>Una versión especial de <a href="saba.php">Jins Saba</a> con su tónica en el 3er grado</h3>
                    </div>
                    <a href="#" class="show-side-menu d-block d-md-none btn btn-primary"><i class="fa fa-fw fa-bars"></i> Índice de Jins</a>
                    <div class="clearfix"></div>

                    <div class="text-center mt-2 mb-3">
                        <a href="#" class="pronunciation btn btn-default" data-audio="/audio/name/saba_dalanshin.mp3"><i class="fa fa-fw fa-volume-up"></i> Pronunciación de Saba Dalanshin</a>
                    </div>
