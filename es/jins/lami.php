...
$page_keywords = "musique arabe, maqam, instruments, jins lami, iqa‘, iqaa, rythme, oud, qanoun, nay, quart de ton, tarab";
$page_language = "es";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <p>Le Jins Lami est un <em>jins</em> de 4 notes. Il est noté ici avec sa tonique sur Ré et son <em>ghammaz</em> sur Sol. Le Jins Lami est le premier jins du <a href="../maqam/lami.php">Maqam Lami</a>.
                    </p>
                    ...
                    <div class="track" data-song="/audio/jins/lami/ahmad_ya_habibi.mp3">
                        <div class="radio">
                            <label>
                                ...
                                <div class="info">
                                    <b>Ahmad Ya Habibi</b>
                                    <span>Interprétation et Musique de Sabri al-Moudallal (Syrie)</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="track" data-song="/audio/jins/lami/qasidat_aqulu.mp3">
                        <div class="radio">
                            <label>
                                <input type="radio" name="song" value="1">
                                <div class="info">
                                    <b>Qassida Aqoulou Wa Qad Nahat Bi Qourbi Hamamatoun</b>
